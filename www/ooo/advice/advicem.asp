...
cidx=Request("cidx")
   ...
   page_name="advicem.asp?listgubun="&listgubun&"&subgubun="&subgubun&"&"
...
SQL=SQL&" Where A.acheoriname='"&c_midx&"' and A.acheorigubun=0 and a.astatus=1"
...
<a name="<%=aidx%>">
					<tr>
						...
						<td width="140" align="center" class="bg-light"><%=aform_text%>/<%=aidx%></td>
