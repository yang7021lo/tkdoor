                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-inline ms-auto me-0 -3 my-2 my-md-0" method="post" action="hinge_item.asp" name="form1">
                                <div class="mb-3">
            ...
            <div class="card mb-4 card-body">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th scope="col">코드</th>
                        <th scope="col">축약어</th>
                        <th scope="col">힌지 이름</th>
                        <th scope="col">힌지 센터</th>
                        <th scope="col">상롯트 파이</th>
                        <th scope="col">힌지 가격</th>
                    ...
                    <tbody class="table-group-divider">
                        ...
                        SQL=SQL&" Where(hingecode like '%"&request("SearchWord")&"%'  or hingeshorten like '%"&request("SearchWord")&"%'  or hingename like '%"&request("SearchWord")&"%'  ) "
                        End If 
                        SQL=SQL&" Order by hingeidx desc "
