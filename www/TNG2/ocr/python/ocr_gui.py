...
# 설정
# ========================================
SERVER_URL = "http://tkd001.cafe24.com/TNG2/ocr/asp/upload_ocr.asp"
IMAGE_DIR = "/img/door/"
RESULT_DIR = "/TNG2/ocr/asp/results/"
...
class OCRApp:
    ...
    def process_files(self):
        ...
        for i, filepath in enumerate(self.selected_files):
            ...
            # 서버 업로드
            self.log("  업로드 중...")
            upload_ok = self.upload_to_server(filepath, result)
        ...
        try:
            ...
            with open(image_path, 'rb') as img_file:
                files = {
                    ...
                    'json': (json_filename, json.dumps(ocr_result, ensure_ascii=False), 'application/json')
                }
            ...
            if response.status_code == 200:
                ...
                self.log(f"  HTTP 오류: {response.status_code}")
                return False
