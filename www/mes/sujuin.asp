...
SQL = " select sjaddress, sjnumber, sjtatus, sjqty, Convert(varchar(10), sujudate,121), sjchulgo "
SQL = SQL & ", Convert(varchar(10), sjchulgodate,121), sjamidx, Convert(varchar(10), sjamdate,121) "
SQL = SQL & ", sjameidx, Convert(varchar(10), sjamedate,121) "
SQL = SQL & ", sjaidx"
...
if rsjbidx<>"" then 
    SQL="SELECT sjbidx, goidx, goprice, sidx, barlistprice, QTYIDX, QTYprice "
    SQL=SQL&" , sjbqty, sjbwide, sjbwidePRICE, sjbhigh, sjbhighPRICE, sjbbanghyang, sjbwitch, sjbbigo "
    SQL=SQL&" , glidx, glprice, sangBUIDX, sangbuprice, pidx, pprice, rhaBUIDX, rHAbuprice "
    SQL=SQL&" , kyidx1, kyprice1, kyidx2, kyprice2, sjbkey3, sjbkey4, kyidx3, kyprice3, kyidx4, kyprice4, sjbkey7, sjbkey8 "
    SQL=SQL&" , tagongidx1, tagongprice1, sjbtagong2, sjbtagong3, sjbtagong4, sjbtagong5 "
    SQL=SQL&" , tagongidx2, tagongprice2, sjbtagong7, sjbtagong8, sjbtagong9, sjbtagong10 "
    SQL=SQL&" , hingeidx, hingeprice, hingeidx1, hingeprice1, sjbhingedown2, sjbhingedown3 "
    SQL=SQL&" , hingeidx3, hingeprice3, hingeidx4, hingeprice4, sjbhingeup2, sjbhingeup3 "
    SQL=SQL&" , sjbkyukja1, kyukjaprice, sjbkyukja2, sjbkyukja3, sjbkyukja4, sjbkyukja5, sjbkyukja6, sjbkyukja7, sjbkyukja8 "
    SQL=SQL&" , sjaidx, sujuinmoneyidx "
    SQL=SQL&" , sjwondanga, sjchugageum, sjgonggeumgaaek, sjDCdanga "
    SQL=SQL&" , sjseaek, sjdanga, sjgeumaek "
    SQL=SQL&" , goname, barNAME, QTYNAME, gldepth "
    SQL=SQL&" , sangbuname, pname, rhabuname, kyname1, kyname2, kyname3, kyname4 "
    SQL=SQL&" , tagongname1, tagongname2, hingename1, hingecenter1, hingename2, hingecenter2, kyukjaname "
    SQL=SQL&" FROM tk_sujub "
    SQL=SQL&" WHERE sjbidx='" & rsjbidx & "' "
    'response.write(SQL)
    Rs.open SQL, Dbcon
    ...
    rhingeidx1=Rs(49)
    rhingeprice1=Rs(50)
    rsjbhingedown2=Rs(51)
    rsjbhingedown3=Rs(52)
    rhingeidx3=Rs(53)
    rhingeprice3=Rs(54)
    rhingeidx4=Rs(55)
    rhingeprice4=Rs(56)
    ...
    rsjbkyukja8=Rs(67)
    rsjaidx=Rs(68)
    rsujuinmoneyidx=Rs(69)
    rsjwondanga=Rs(70)
    rsjchugageum=Rs(71)
    rsjgonggeumgaaek=Rs(72)
    rsjDCdanga=Rs(73)
    rsjseaek=Rs(74)
    rsjdanga=Rs(75)
    rsjgeumaek=Rs(76)
...
<head>
    ...
    <script>
        function validateForm_sujua(){
                document.frmMain_sujua.submit();
            }
        function validateForm_sujub(){
                document.frmMain_sujub.submit();
            }    
    </script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const inputs = [
            'cidx_1','goidx_1', 'sjaidx_1', 'sjbidx_1', 'goprice_1', 'rsplit', 'QTYIDX', 'QTYprice', 'QTYNAME', 
            'sjbqty', 'sjbwide', 'sjbwidePRICE', 'sjbhigh', 'sjbhighPRICE', 'sjbwitch', 'sjbbigo', 
            'sjgonggeumgaaek', 'sjwondanga', 'sjchugageum', 'sjDCdanga', 'sjgeumaek', 'sjdanga', 'sjseaek', 
            'glidx', 'glprice', 'gldepth', 'SANGBUIDX', 'SANGbuprice', 'SANGbuname', 'pidx', 'pprice', 'pname', 
            'rHABUIDX', 'rHAbuprice', 'rHAbuname', 'kyidx1', 'kyprice1', 'kyname1', 'kyidx2', 'kyprice2', 'kyname2', 
            'sjbkey3', 'sjbkey4', 'kyidx3', 'kyprice3', 'kyname3', 'kyidx4', 'kyprice4', 'kyname4', 'sjbkey7', 'sjbkey8', 
            'tagongidx1', 'tagongprice1', 'tagongname1', 'sjbtagong4', 'sjbtagong5', 'tagongidx2', 'tagongprice2', 'tagongname2', 
            'sjbtagong7', 'sjbtagong8', 'sjbtagong9', 'sjbtagong10', 'sjbtagong11', 'hingeidx', 'hingeprice', 'hingename1', 
            'hingeidx1', 'hingeprice1', 'hingecenter1', 'sjbhingedown2', 'sjbhingedown3', 'hingeidx3', 'hingeprice3', 
            'hingename2', 'hingeidx4', 'hingeprice4', 'hingecenter2', 'sjbhingeup2', 'sjbhingeup3', 'sjbkyukja1', 
            'kyukjaprice', 'kyukjaname', 'sjbkyukja2', 'sjbkyukja3', 'sjbkyukja4', 'sjbkyukja5', 'sjbkyukja6', 
            'sjbkyukja7', 'sjbkyukja8'
        ].map(id => document.getElementById(id)).filter(el => el !== null);
        
        const selects = [
            'rsplit1', 'rsplit2', 'sjbbanghyang', 'rsplit3', 'rsplit4', 'rsplit5', 'rsplit6', 'rsplit7', 
            'rsplit8', 'rsplit9', 'rsplit10', 'rsplit11', 'sjbtagong2', 'sjbtagong3', 'rsplit12', 'rsplit13', 
            'rsplit14', 'rsplit15', 'rsplit16'
    ...
    <script>
        $(document).ready(function() {
            function updateResults() {
                ...
                const sidx = parseFloat(parts1[0]) || 0; // Get the first number
                ...
                $('#sidx').val(sidx); // Display the first value
...
<body class="sb-nav-fixed" >
    <div id="layoutSidenav_content">     <!-- DIV 1-->         
        <main>
        <div class="container-fluid px-4">    <!-- DIV 2-->  
            <div class="row justify-content-between  mt-2">    <!-- DIV 3--> 
    <!-- 내용 입력 시작 -->  
    <!--거래처 시작 -->
    ...
    <!--수주일자 시작 -->
                <% if rsjaidx="" then  %>
                <form name="frmMain_sujua" action="sujuindbA.asp" method="post">
                <% else %>
                <form name="frmMain_sujua" action="sujuindbAU.asp" method="post"> 
                    <input type="text" name="sjaidx" value="<%=rsjaidx%>">
                <% end if%>
                    ...
                    <div class="card card-body mb-1">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-4">
                                ...
                                <% if rsjaidx="" then  %>
                                    <button type="button" class="btn btn-outline-primary" onclick="validateForm_sujua();">저장</button>
                                <% else %>
                                    <button type="button" class="btn btn-outline-secondary" onclick="validateForm_sujua();">수정</button>
                                <% end if %>
                                </div>     
                                ...
                                <button class="btn btn-danger"  type="submit" >파일보기</button>
                                <button class="btn btn-warning"  type="submit" >액셀불러오기</button>
                            </div> 
                            <div class="col-md-6 card card-body mb-1  ">
                                <div class="row">
                                    <div class="col-md-1 text-end">
                                    <label for="name">전체합계</label>
                                    </div>
                                    <div class="col-md-4">
                ...
                <!-- form b sujuindb 시작 -->
                <form id="myForm" name="frmMain_sujub" action="sujuindbb.asp" method="post">
                    <%
                    %>
                    <input type="hidden" id="cidx_1" name="cidx" value="<%=rcidx%>" >
                    <input type="TEXT" id="goidx_1" name="goidx" value="<%=rgoidx%>" >
                    <input type="hidden" id="sjaidx_1" name="sjaidx" value="<%=rsjaidx%>" >
                    <input type="TEXT" id="sjbidx_1" name="sjbidx" value="<%=rsjbidx%>" >
                    <input type="hidden" id="goprice_1" name="goprice" value="<%=goprice%>"  >  <!-- inputVal -->    
                    <div class="row"> <!-- DIV 4-->  
                        <div class="col-md-4"> <!--좌측 카드바디 시작 -->
                            <div class="card card-body mb-1"> 
                                <div class="row mb-1"> <!--품명 시작 -->
                                    ...
                                    <div class="col-6">
                                        ...
                                        onclick="window.open('goodch.asp?cidx=<%=rcidx%>&sjaidx=<%=rsjaidx%>','_blank','width=1000  , height=1000, top=200, left=500' );">
                                    </div>
                                    <div class="col-5"><%=rsidx%>
                                    ...
                                    Do until Rs.EOF
                                        ...
                                        barlistprice=Rs(3)
                                    %>  
                                    <option value="<%=sidx%>_<%=barlistprice%>_<%=barNAME%>" <% if cint(sidx)=cint(rsidx) then %>selected <% end if %>> <%=barNAME%>/<%=sidx%></option>
                                    <%
                                        Rs.MoveNext
                                        Loop
                                        End If
                                ...
                                <div class="row mb-1"> <!--재질 , 수량 시작 -->
                                    ...
                                    <select name="sjbjaejil" class="form-control" id="rsplit2" required>
                                        ...
                                        QTYprice=Rs(13)
                                        %>                
                                        <option value="<%=QTYIDX%>_<%=QTYprice%>_<%=QTYNAME%>" <% if cint(QTYIDX)=cint(rQTYIDX) then %> selected <% end if %>><%=QTYNAME%></option>
                                        <%
                                        Rs.MoveNext
                                        Loop
                                        End If
                                    ...
                                    <div class="col-2">
                                    <input type="number" class="form-control" id="sjbqty" name="sjbqty" placeholder="" value="<%=rsjbqty%>"  >
                                    </div>
                                </div>   <!--재질 , 수량 끝 -->
                                <div class="row mb-1">  <!--규격,방향 시작 -->
                                    <div class="col-1"><label for="name">규격</label></div> 
                                    <div class="col-3">
                                        <input type="number" class="form-control" id="sjbwide" name="sjbwide" placeholder="가로" value="<%=rsjbwide%>" required>
                                        <input type="number" name="sjbwidePRICE"  id="sjbwidePRICE" value="<%=rsjbwidePRICE%>">
                                    </div>     
                                    <div class="col-1">X</div>
                                    <div class="col-3">    
                                        <input type="number" class="form-control" id="sjbhigh" name="sjbhigh" placeholder="세로" value="<%=rsjbhigh%>" >
                                        <input type="number" name="sjbhighPRICE" id="sjbhighPRICE" value="<%=rsjbhighPRICE%>" >
                                    </div>    
                                    <script>
                                    ...
                                    <select name="sjbbanghyang" class="form-control" id="sjbbanghyang" required >
                                        <option value="1" <% if rsjbbanghyang="1" then %> selected <% end if %>>좌</option>
                                        <option value="2" <% if rsjbbanghyang="2" then %> selected <% end if %>>우 </option>
                                        <option value="3" <% if rsjbbanghyang="3" then %> selected <% end if %>>양개(좌)</option>
                                        <option value="4" <% if rsjbbanghyang="4" then %> selected <% end if %>>양개(우)</option>
                                        <option value="5" <% if rsjbbanghyang="5" then %> selected <% end if %>>양개</option>              
                                    </select>
                                    </div>
                                </div>  <!--규격,방향 끝 -->
                                <div class="row mb-1"> <!--위치,비고 시작 -->
                                    <div class="col-2"><label for="name">위치</label></div>
                                    <div class="col-10">
                                    <input type="text" class="form-control" id="sjbwitch" name="sjbwitch" placeholder="" value="<%=rsjbwitch%>" >
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-2"><label for="name">비고</label></div>
                                    <div class="col-10">
                                    <input type="text" class="form-control" id="sjbbigo" name="sjbbigo" placeholder="" value="<%=rsjbbigo%>" >
                                    </div>
                                </div>   <!--위치,비고 끝 -->
                                <div class="row mb-1">  <!--합계 시작 -->
                                    <div class="row"><label for="name">합계</label>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" class="form-control" id="levelDC" name="levelDC" placeholder="" value="<%=rsjgeumaek%>"  >
                                            </div> 
                                            <div class="col-md-3">
                                                <label for="name">%할인</label>
                                                <input type="number" class="form-control" id="proTGDC" name="proTGDC" placeholder="" value="<%=rsjdanga%>"  >
                                            </div>
                                            <div class="col-md-3">
                                                <label for="name">타공/키할인</label>
                                                <input type="number" class="form-control" id="tgkeyDC" name="tgkeyDC" placeholder="" value="<%=rsjseaek%>"  >
                                            </div> 
                                        </div>
                                        <div class="col-md-3">
                                            <label for="name">공급가액</label>
                                            <input type="number" class="form-control" id="sjgonggeumgaaek" name="sjgonggeumgaaek" placeholder="" value="<%=rsjgonggeumgaaek%>"  >
                                        </div>
                                        <div class="col-md-3">
                                            <label for="name">기본단가</label>
                                            <input type="number" class="form-control" id="sjwondanga" name="sjwondanga" placeholder="" value="<%=rsjwondanga%>" >
                                        </div>
                                        <div class="col-md-3">
                                            <label for="name">추가금</label>
                                            <input type="number" class="form-control" id="sjchugageum" name="sjchugageum" placeholder="" value="<%=rsjchugageum%>"  >
                                        </div>  
                                        <div class="col-md-3">
                                            <label for="name">할인단가</label>
                                            <input type="number" class="form-control" id="sjDCdanga" name="sjDCdanga" placeholder="" value="<%=rsjDCdanga%>"  >
                                        </div>  
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="name">총금액</label>
                                            <input type="number" class="form-control" id="sjgeumaek" name="sjgeumaek" placeholder="" value="<%=rsjgeumaek%>"  >
                                        </div> 
                                        <div class="col-md-3">
                                            <label for="name">단가</label>
                                            <input type="number" class="form-control" id="sjdanga" name="sjdanga" placeholder="" value="<%=rsjdanga%>"  >
                                        </div>
                                        <div class="col-md-3">
                                            <label for="name">세액</label>
                                            <input type="number" class="form-control" id="sjseaek" name="sjseaek" placeholder="" value="<%=rsjseaek%>"  >
                                        </div> 
                                        <div class="col-md-3">
                        ...
                        <div class="col-md-4"> <!--중앙 카드바디 시작 -->
                            <div class="card card-body mb-1">
                                <div class="row mb-1"> 
                                    <div class="col-2"><label for="name">유리</label></div> <!--유리 시작 --> 
                                    <div class="col-4">
                                        <select name="sjbglass" class="form-control" id="rsplit3" required>
                                            ...
                                            %>                
                                                <option value="<%=glidx%>_<%=glprice%>_<%=gldepth%>" <% if Cint(glidx)=Cint(rglidx) Then %>selected <% end if %>><%=gldepth%>mm</option>
                                            <%
                                            Rs.MoveNext
                                            Loop
                                            End If
                                        ...
                                        <input type="hidden" name="glidx" id="glidx" value="<%=rglidx%>" > 
                                        <input type="hidden" name="glprice" id="glprice" value="<%=rglprice%>" > 
                                        <input type="hidden" name="gldepth" id="gldepth" value="<%=rgldepth%>" >   
                                    </div>  <!--유리 끝 -->
                                    <div class="col-2"><label for="name">상바</label></div> <!--상바 시작 -->  
                                    <div class="col-4">
                                        <select name="sjbsangbar" class="form-control" id="rsplit4" required>
                                            ...
                                            SANGbuprice=rs(5)
                                            %>                
                                                <option value="<%=SANGBUIDX%>_<%=SANGbuprice%>_<%=SANGbuname%>" <% if Cint(SANGBUIDX)=Cint(rSANGBUIDX) Then %>selected <% end if %>><%=SANGbuname%></option>
                                            <%
                                            Rs.MoveNext
                                            Loop
                                            End If
                                        ...
                                        <input type="hidden" name="SANGBUIDX" id="SANGBUIDX" value="<%=rSANGBUIDX%>" > 
                                        <input type="hidden" name="SANGbuprice" id="SANGbuprice" value="<%=rSANGbuprice%>" > 
                                        <input type="hidden" name="SANGbuname" id="SANGbuname" value="<%=rSANGbuname%>" >
                                    </div> <!--상바 끝 -->
                                </div> 
                                <div class="row mb-1"> 
                                    <div class="col-2"><label for="name">도장</label></div>  <!--도장 시작 --> 
                                    <div class="col-4">
                                        <select name="sjbpaint" class="form-control" id="rsplit5" required>
                                            ...
                                            pewdate=Rs(8)
                                            %>                
                                                <option value="<%=pidx%>_<%=pprice%>_<%=pname%>" <% if Cint(pidx)=Cint(rpidx) Then %>selected <% end if %>><%=pname%></option>
                                            <%
                                            Rs.MoveNext
                                            Loop
                                            End If
                                        ...
                                        <input type="hidden" name="pidx" id="pidx" value="<%=rpidx%>" > 
                                        <input type="hidden" name="pprice" id="pprice" value="<%=rpprice%>" > 
                                        <input type="hidden" name="pname" id="pname" value="<%=rpname%>" >
                                    </div>   <!--도장 끝 -->
                                    <div class="col-2"><label for="name">하바</label></div> <!--하바 시작 -->  
                                    <div class="col-4">
                                        <select name="sjbhabar" class="form-control" id="rsplit6" required>
                                            ...
                                            rHAbuprice=rs(5)
                                            %>                
                                                <option value="<%=rHABUIDX%>_<%=rHAbuprice%>_<%=rHAbuname%>" <% if Cint(rHABUIDX)=Cint(rrHABUIDX) Then %>selected <% end if %>><%=rHAbuname%></option>
                                            <%
                                            Rs.MoveNext
                                            Loop
                                            End If
                                        ...
                                        <input type="hidden" name="rHABUIDX" id="rHABUIDX" value="<%=rrHABUIDX%>" > 
                                        <input type="hidden" name="rHAbuprice" id="rHAbuprice" value="<%=rrHAbuprice%>" > 
                                        <input type="hidden" name="rHAbuname" id="rHAbuname" value="<%=rrHAbuname%>" >
                                    </div>  <!--하바 끝 -->
                                </div> 
                                <div class="row mb-1">  <!--키 시작 -->  
                                    <div class="col-2"><label for="name">상키</label></div>   
                                    <div class="col-2">
                                        <select name="sjbkey1" class="form-control" id="rsplit7" required>
                                            <%
                                            SQL=" Select kyidx, kycode, kyshorten, kyname, kyprice, kymidx, kywdate ,kyemidx, kyewdate,kywitch,kyselect "
                                            SQL=SQL&" From tk_key "
                                            SQL=SQL&" Where kystatus=1 and  kyselect=3"
                                            RESPONSE.WRITE SQL 
                                            Rs.open Sql,Dbcon
                                            If Not (Rs.bof or Rs.eof) Then 
                                            Do until Rs.EOF
                                            ...
                                            kyselect=Rs(10)
                                            %>                
                                                <option value="<%=kyidx1%>_<%=kyprice1%>_<%=kyname1%>" <% if Cint(kyidx1)=Cint(rkyidx1) Then %>selected <% end if %>><%=kyname1%></option>
                                        ...
                                        <input type="hidden" name="kyidx1" id="kyidx1" value="<%=rkyidx1%>" > 
                                        <input type="hidden" name="kyprice1" id="kyprice1" value="<%=rkyprice1%>" > 
                                        <input type="hidden" name="kyname1" id="kyname1" value="<%=rkyname1%>" >
                                    </div>
                                    <div class="col-3">
                                    <select name="sjbkey2" class="form-control" id="rsplit8" required>
                                            ...
                                            SQL=" Select kyidx, kycode, kyshorten, kyname, kyprice, kymidx, kywdate ,kyemidx, kyewdate,kywitch,kyselect "
                                            SQL=SQL&" From tk_key "
                                            SQL=SQL&" Where kystatus=1 and ( kyselect=1 or kyselect=2 or kyselect=3 ) "
                                            RESPONSE.WRITE SQL 
                                            Rs.open Sql,Dbcon
                                            If Not (Rs.bof or Rs.eof) Then 
                                            Do until Rs.EOF
                                            ...
                                            kyselect=Rs(10)
                                            %>                 
                                                <option value="<%=kyidx2%>_<%=kyprice2%>_<%=kyname2%>" <% if Cint(kyidx2)=Cint(rkyidx2) Then %>selected <% end if %>><%=kyname2%></option>
                                        ...
                                        <input type="hidden" name="kyidx2" id="kyidx2" value="<%=rkyidx2%>" > 
                                        <input type="hidden" name="kyprice2" id="kyprice2" value="<%=rkyprice2%>" > 
                                        <input type="hidden" name="kyname2" id="kyname2" value="<%=rkyname2%>" >
                                    </div>
                                    <div class="col-3">
                                        <input type="text" class="form-control" id="sjbkey3" name="sjbkey3" placeholder="중키높이지정" value="<%=rsjbkey3%>" >
                                    </div>
                                    <div class="col-2">
                                        <input type="text" class="form-control" id="sjbkey4" name="sjbkey4" placeholder="수기단가입력" value="<%=rsjbkey4%>" >
                                    </div>
                                </div>
                                <div class="row mb-1">   
                                    <div class="col-2"><label for="name">하키</label></div>   
                                    <div class="col-2">
                                    <select name="sjbkey5" class="form-control" id="rsplit9" required>
                                        <%
                                        SQL=" Select kyidx, kycode, kyshorten, kyname, kyprice, kymidx, kywdate ,kyemidx, kyewdate,kywitch,kyselect "
                                        SQL=SQL&" From tk_key "
                                        SQL=SQL&" Where kystatus=1 and  kyselect=4"
                                        RESPONSE.WRITE SQL 
                                        Rs.open Sql,Dbcon
                                        If Not (Rs.bof or Rs.eof) Then 
                                        Do until Rs.EOF
                                        ...
                                        kyselect=Rs(10)
                                        %>                
                                            <option value="<%=kyidx3%>_<%=kyprice3%>_<%=kyname3%>" <% if Cint(kyidx3)=Cint(rkyidx3) Then %>selected <% end if %>><%=kyname3%></option>
                                        <%
                                        Rs.MoveNext
                                        Loop
                                        End If
                                        ...
                                        <input type="hidden" name="kyidx3" id="kyidx3" value="<%=rkyidx3%>" > 
                                        <input type="hidden" name="kyprice3" id="kyprice3" value="<%=rkyprice3%>" > 
                                        <input type="hidden" name="kyname3" id="kyname3" value="<%=rkyname3%>" >
                                    </div>
                                    <div class="col-3">
                                        ...
                                        kyewdate=Rs(8)
                                        %>                
                                            <option value="<%=kyidx4%>_<%=kyprice4%>_<%=kyname4%>" <% if Cint(kyidx4)=Cint(rkyidx4) Then %>selected <% end if %>><%=kyname4%></option>
                                        <%
                                        Rs.MoveNext
                                        Loop
                                        End If
                                    ...
                                    <input type="hidden" name="kyidx4" id="kyidx4" value="<%=rkyidx4%>" > 
                                    <input type="hidden" name="kyprice4" id="kyprice4" value="<%=rkyprice4%>" > 
                                    <input type="hidden" name="kyname4" id="kyname4" value="<%=rkyname4%>" >        
                                    </div>
                                    <div class="col-3">
                                        <input type="text" class="form-control" id="sjbkey7" name="sjbkey7" placeholder="중키높이지정" value="<%=rsjbkey7%>" >          
                                    </div>
                                    <div class="col-2">
                                        <input type="text" class="form-control" id="sjbkey8" name="sjbkey8" placeholder="수기단가입력" value="<%=rsjbkey8%>" >          
                                    </div>
                                </div> <!--키 끝 -->
                                <div class="row mb-1"><!--손잡이 1시작 -->   
                                    <div class="col-3"><label for="name" class="horizontal-text" >핸들타공</label>
                                    <select name="sjbtagong1" class="form-control" id="rsplit11" required>
                                        ...
                                        tagongewdate=Rs(9)
                                        %>                
                                            <option value="<%=tagongidx1%>_<%=tagongprice1%>_<%=tagongname1%>" <% if Cint(tagongidx1)=Cint(rtagongidx1) Then %>selected <% end if %>><%=tagongname1%></option>
                                        <%
                                        Rs.MoveNext
                                        Loop
                                        End If
                                    ...
                                    <input type="hidden" name="tagongidx1" id="tagongidx1" value="<%=rtagongidx1%>" > 
                                    <input type="hidden" name="tagongprice1" id="tagongprice1" value="<%=rtagongprice1%>" > 
                                    <input type="hidden" name="tagongname1" id="tagongname1" value="<%=rtagongname1%>" >  
                                    </div>
                                    <div class="col-3"><label for="name" class="horizontal-text" >타공거리</label>
                                        <select class="form-select" name="sjbtagong2" id="sjbtagong2">
                                            <option value="1" <% if rsjbtagong2="1" then  %>selected<% end if %>>900-340</option>
                                            <option value="2" <% if rsjbtagong2="2" then  %>selected<% end if %>>800-600</option>
                                            <option value="3" <% if rsjbtagong2="3" then  %>selected<% end if %>>600-800</option>
                                            <option value="4" <% if rsjbtagong2="4" then  %>selected<% end if %>>600-1000</option>
                                            <option value="5" <% if rsjbtagong2="4" then  %>selected<% end if %>>C1200</option> 
                                        </select>   
                                    </div>
                                    <div class="col-2"><label for="name" class="horizontal-text" >폭</label>
                                        ...
                                        tagongfok=Rs(1)
                                        %>                
                                            <option value="<%=tagongfok%>" <% if Cint(smidx)=Cint(smidx) Then %>selected <% end if %>><%=tagongfok%></option>
                                        <%
                                        Rs.MoveNext
                                        Loop
                                        End If
                                    ...
                                    <div class="col-2"><label for="name" class="horizontal-text" >높이</label>
                                        <select name="sjbtagong4" class="form-control" id="sjbtagong4" required>
                                        <%
                                        SQL=" Select B.smidx, B.tagonghigh"
                                        SQL=SQL&" From tk_stand A "
                                        SQL=SQL&" Join tk_material  B On  A.sidx=B.sidx AND B.tagonghigh > 0 "
                                        SQL=SQL&" Where A.sidx='"&sidx&"'  "
                                        RESPONSE.WRITE (SQL)
                                        Rs.open Sql,Dbcon
                                        If Not (Rs.bof or Rs.eof) Then 
                                        ...
                                        tagonghigh=Rs(1)
                                        %>                
                                            <option value="<%=tagonghigh%>" <% if Cint(smidx)=Cint(rsmidx) Then %>selected <% end if %>><%=tagonghigh%></option>
                                        <%
                                        Rs.MoveNext
                                        Loop
                                        End If
                                    ...
                                    <div class="col-2"><label for="name" class="horizontal-text" >추가금</label>
                                        <input type="text" class="form-control" id="sjbtagong5" name="sjbtagong5" placeholder="" value="<%=rsjbtagong5%>" >           
                                    </div>                             
                                </div> <!--손잡이 1끝 -->
                                <div class="row mb-1">   <!--타공위치 시작 --> 
                                    <div class="col-2">
                                        ...
                                        tagongewdate=Rs(9)
                                        %>                
                                            <option value="<%=tagongidx2%>_<%=tagongprice2%>_<%=tagongname2%>" <% if Cint(tagongidx2)=Cint(rtagongidx2) Then %>selected <% end if %>><%=tagongname2%>mm</option>
                                        <%
                                        Rs.MoveNext
                                        Loop
                                        End If
                                        ...
                                        <input type="hidden" name="tagongidx2" id="tagongidx2" value="<%=rtagongidx2%>" > 
                                        <input type="hidden" name="tagongprice2" id="tagongprice2" value="<%=rtagongprice2%>" > 
                                        <input type="hidden" name="tagongname2" id="tagongname2" value="<%=rtagongname2%>" >  
                                    </div>
                                    <div class="col-2"><label for="name" class="horizontal-text" >1홀</label>
                                        <input type="text" class="form-control" id="sjbtagong7" name="sjbtagong7" placeholder="" value="<%=rsjbtagong7%>" >  
                                    </div>
                                    <div class="col-2"><label for="name" class="horizontal-text" >2홀</label>
                                        <input type="text" class="form-control" id="sjbtagong8" name="sjbtagong8" placeholder="" value="<%=rsjbtagong8%>" > 
                                    </div>
                                    <div class="col-2"><label for="name" class="horizontal-text" >3홀</label>
                                        <input type="text" class="form-control" id="sjbtagong9" name="sjbtagong9" placeholder="" value="<%=rsjbtagong9%>" >           
                                    </div>
                                    <div class="col-2"><label for="name" class="horizontal-text" >4홀</label>
                                        <input type="text" class="form-control" id="sjbtagong10" name="sjbtagong10" placeholder="" value="<%=rsjbtagong10%>" >           
                                    </div>    
                                    <div class="col-2"><label for="name" class="horizontal-text" >홀수</label> <!--미입력 -->
                                        <input type="text" class="form-control" id="sjbtagong11" name="sjbtagong11" placeholder="" value="<%=rsjbtagong11%>" >           
                                    </div>                                        
                                </div> <!--타공위치 끝 -->
                                <div class="row mb-1"> 
                                    <div class="col-2"><label for="name">하롯트</label></div> <!--하롯트 시작 -->   
                                    <div class="col-3">
                                    ...
                                    atype=Rs(13)
                                    %>                
                                        <option value="<%=hingeidx%>_<%=hingeprice%>_<%=hingename1%>" <% if Cint(hingeidx)=Cint(rhingeidx) Then %>selected <% end if %>><%=hingename1%></option>
                                    <%
                                    Rs.MoveNext
                                    Loop
                                    End If
                                    ...
                                    %>
                                        ...
                                        <input type="hidden" name="hingeidx" id="hingeidx" value="<%=rhingeidx%>" > 
                                        <input type="hidden" name="hingeprice" id="hingeprice" value="<%=rhingeprice%>" > 
                                        <input type="hidden" name="hingename1" id="hingename1" value="<%=rhingename1%>" >  
                                    </div>
                                    <div class="col-2">
                                    ...
                                    atype=Rs(13)
                                    %>                
                                        <option value="<%=hingeidx1%>_<%=hingeprice1%>_<%=hingecenter1%>" <% if Cint(hingeidx1)=Cint(rhingeidx1) Then %>selected <% end if %>><%=hingecenter1%>mm</option>
                                    <%
                                    Rs.MoveNext
                                    Loop
                                    End If
                                    ...
                                    <input type="hidden" name="hingeidx1" id="hingeidx1" value="<%=rhingeidx1%>" > 
                                        <input type="hidden" name="hingeprice1" id="hingeprice1" value="<%=rhingeprice1%>" > 
                                        <input type="hidden" name="hingecenter1" id="hingecenter1" value="<%=rhingecenter1%>" >  
                                    </div>
                                    <div class="col-3">
                                    <input type="text" class="form-control" id="sjbhingedown2" name="sjbhingedown2" placeholder="" value="<%=rsjbhingedown2%>" >          
                                    </div>
                                    <div class="col-2">
                                    <input type="text" class="form-control" id="sjbhingedown3" name="sjbhingedown3" placeholder="" value="<%=rsjbhingedown3%>" >          
                                    </div>  <!--하롯트 끝 -->
                                    <div class="col-2"><label for="name">상롯트</label></div>     <!--상롯트 시작 -->                      
                                    <div class="col-3">
                                    ...
                                    atype=Rs(13)
                                    %>                
                                        <option value="<%=hingeidx3%>_<%=hingeprice3%>_<%=hingename2%>" <% if Cint(hingeidx3)=Cint(rhingeidx3) Then %>selected <% end if %>><%=hingename2%></option>
                                    <%
                                    Rs.MoveNext
                                    Loop
                                    End If
                                    ...
                                    <input type="hidden" name="hingeidx3" id="hingeidx3" value="<%=rhingeidx3%>" > 
                                        <input type="hidden" name="hingeprice3" id="hingeprice3" value="<%=rhingeprice3%>" > 
                                        <input type="hidden" name="hingename2" id="hingename2" value="<%=rhingename2%>" >  
                                    </div>
                                    <div class="col-2">
                                    ...
                                    atype=Rs(13)
                                    %>                
                                        <option value="<%=hingeidx4%>_<%=hingeprice4%>_<%=hingecenter2%>" <% if Cint(hingeidx4)=Cint(rhingeidx4) Then %>selected <% end if %>><%=hingecenter2%>mm</option>
                                    <%
                                    Rs.MoveNext
                                    Loop
                                    End If
                                    ...
                                    %>                    
                                        ...
                                        <input type="hidden" name="hingeidx4" id="hingeidx4" value="<%=rhingeidx4%>" > 
                                        <input type="hidden" name="hingeprice4" id="hingeprice4" value="<%=rhingeprice4%>" > 
                                        <input type="hidden" name="hingecenter2" id="hingecenter2" value="<%=rhingecenter2%>" >      
                                    </div> 
                                    <div class="col-3">
                                    <input type="text" class="form-control" id="sjbhingeup2" name="sjbhingeup2" placeholder="" value="<%=rsjbhingeup2%>" > 
                                    </div>
                                    <div class="col-2">
                                    <input type="text" class="form-control" id="sjbhingeup3" name="sjbhingeup3" placeholder="" value="<%=rsjbhingeup3%>" > 
                                    </div>   <!--상롯트 끝 -->                          
                                </div>
                                <div class="row mb-1"> <!--격자 시작 -->   
                                    <div class="col-2"><label for="name">격자</label></div>   
                                    <div class="col-3">
                                    <input type="text" class="form-control" id="sjbkyukja1" name="sjbkyukja1" placeholder="" value="<%=rsjbkyukja1%>" > 
                                    <input type="hidden" class="form-control" id="kyukjaprice" name="kyukjaprice" placeholder="" value="<%=rkyukjaprice%>" > 
                                    <input type="hidden" class="form-control" id="kyukjaname" name="kyukjaname" placeholder="" value="<%=rkyukjaname%>" > 
                                    </div>
                                    <div class="col-3">
                                    <input type="text" class="form-control" id="sjbkyukja2" name="sjbkyukja2" placeholder="" value="<%=rsjbkyukja2%>" > 
                                    </div>
                                    <div class="col-2">
                                    <input type="text" class="form-control" id="sjbkyukja3" name="sjbkyukja3" placeholder="" value="<%=rsjbkyukja3%>" >                  
                                    </div>
                                    <div class="col-2">
                                    <input type="text" class="form-control" id="sjbkyukja4" name="sjbkyukja4" placeholder="" value="<%=rsjbkyukja4%>" >        
                                    </div>                  
                                </div>
                                <div class="row mb-1">
                                    <div class="col-2"><label for="name">입력</label></div>
                                    <div class="col-2">
                                        <input type="text" class="form-control" id="sjbkyukja5" name="sjbkyukja5" placeholder="" value="<%=rsjbkyukja5%>" >           
                                    </div>  
                                    <div class="col-2">
                                        <input type="text" class="form-control" id="sjbkyukja6" name="sjbkyukja6" placeholder="" value="<%=rsjbkyukja6%>" >           
                                    </div>  
                                    <div class="col-2">
                                        <input type="text" class="form-control" id="sjbkyukja7" name="sjbkyukja7" placeholder="" value="<%=rsjbkyukja7%>" >           
                                    </div>
                                    <div class="col-2">
                                        <input type="text" class="form-control" id="sjbkyukja8" name="sjbkyukja8" placeholder="" value="<%=rsjbkyukja8%>" >           
                                    </div>                
                                </div> <!--격자 끝 -->  
                            </div>
                        </div> <!--중앙 카드바디 끝 -->
                </form>  <!--form b sujuindb 끝 --> 
                        <div class="col-md-4">  <!--sujumaterial 시작 -->      
                            <div class="row card mb-2" style="height:300px;">
                                <iframe name="sujumaterial" width="100%" height="100%" src="sujuinb_material.asp?<%=rgoidx%>&rsidx=<%=rsidx%>&rbuidx=<%=rbuidx%>&smidx=<%=smidx%>" border="0" scrolling="none"></iframe>
                            </div>
                        </div>      <!--sujumaterial 끝 -->    
                        <div class="row justify-content-between">  <!--수주내역 시작 -->
                            <div class="card card-body mb-1"><label for="name">수주내역</label>
                                <div class="row">
                                    <table id="datatablesSimple"  class="table table-hover">
                                        ...
                                        <tbody>
                                            <%
                                            SQL="SELECT A.sjbidx,A.goidx,A.goprice,A.sidx,A.barlistprice,A.QTYIDX,A.QTYprice "
                        ...
                        <div class="card card-body mb-1"> <!-- 기타자재 시작 -->
                            <div class="row">
                            <!-- Navbar Search-->
