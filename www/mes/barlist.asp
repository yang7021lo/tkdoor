...
rbaridx=Request("baridx")
'Response.write rgoidx&"<br>"

if gubun="insert" and rgoidx<>"" and rbaridx<>"" then  

SQL=" Insert into tk_stand (goidx, baridx, smidx, swdate) "
SQL=SQL&" Values ('"&rgoidx&"','"&rbaridx&"','"&C_midx&"', getdate()) "
'response.write (SQL)
'response.end
Dbcon.execute (SQL)

Response.write "<script>window.parent.location.replace('pummok_door.asp?rgoidx="&rgoidx&"');</script>"
%>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <table id="datatablesSimple"  class="table" >
                            ...
                            <tbody>
                                ...
                                SQL=SQL&" Where A.baridx not in (select D.baridx from tk_stand D Where D.goidx='"&rgoidx&"')  "
                                ...
                                %> 
                                    <tr>
                                        <td><%=yyy%></td>
                                        <td><a href="barlist.asp?gubun=insert&rgoidx=<%=rgoidx%>&barIDX=<%=barIDX%>"><%=barNAME%></a></td>
                                        <!--
                                        <td><%=atype_text%></td>
                                        -->
                                    </tr>
