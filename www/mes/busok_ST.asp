                    ...
                    <div class="row justify-content-between">
                        <div class="card card-body mb-4">
                            <table id="datatablesSimple"  class="table table-hover">
                                ...
                                sQL=" Select A.BUIDX, A.buname, A.atype, A.BUSELECT, A.bumidx, Convert(Varchar(10),A.buwdate,121), B.mname , Convert(Varchar(10),A.buewdate,121), C.mname , Buprice ,BUST_GLASS "
                                ...
                                SQL=SQL&" Where A.buidx<>'' AND (A.BUSELECT='스텐_다대바' OR A.BUSELECT='스텐_에치바') "
                                ...
                                <tr>
                                    <td><%=yyy%></td>
                                    <td><a href="busok_ST.asp?gubun=insert&rgoidx=<%=rgoidx%>&rsidx=<%=rsidx%>&rbuidx=<%=buidx%>"><%=buname%></a></td>
                                    <td><%=BUST_GLASS%></a></td>
                                </tr>
                                <%
                                Rs.movenext
