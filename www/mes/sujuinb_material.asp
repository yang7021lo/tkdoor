        ...
        <div class="mt-1"><h5>공정구성</h5></div>
            <div class="input-group mb-3">
                <table id="datatablesSimple"  class="table table-border">
                    ...
                    SQL=SQL&" , A.smmidx, Convert(varchar(16),A.smwdate,121), A.smemidx, Convert(varchar(16),A.smewdate,121) "
                    SQL=SQL&" From tk_material A "
                    SQL=SQL&" Join tk_busok B  On A.buidx=B.buidx "
                    SQL=SQL&" Join tk_sujub C On A.sidx=C.sidx "
                    SQL=SQL&" Where C.sjbidx='"&sjbidx&"' "
                    'Response.write (SQL)	
