...
response.write "rsjbidx;"&rsjbidx&"<br>"
response.write "goidx;"&goidx&"<br>"
response.write "goprice;"&goprice&"<br>"
response.write "goname;"&sjbpummyoung&"<br>"
Response.write "sjbjaejil:"&sjbjaejil&"<br>"
Response.write "sjbjaejil:"&sjbjaejil&"<br>"
Response.write "sjbglass:"&sjbglass&"<br>"
Response.write "sjbsangbar:"&sjbsangbar&"<br>"
'response.end
...
Response.write "sjbidx:"&rsjbidx&"<br>"
...
SQL="select max(sjbidx)+1 from tk_sujub "
Rs.open Sql,Dbcon
...
'response.end
SQL="Insert into tk_sujub (sjbidx, goidx, goprice, sidx, barlistprice, QTYIDX, QTYprice, "
...
SQL=SQL&"sjaidx, cidx, sujuinmoneyidx, "
SQL=SQL&"sjwondanga, sjchugageum, sjgonggeumgaaek, sjDCdanga, "
SQL=SQL&"sjseaek, sjdanga, sjgeumaek, "
SQL=SQL&"sjbpummyoung, barNAME, QTYNAME, gldepth, "
SQL=SQL&"sangbuname, pname, rHAbuname, kyname1, kyname2, kyname3, kyname4, "
SQL=SQL&"tagongname1, tagongname2, hingename1, hingecenter1, hingename2, hingecenter2, kyukjaname, sjbtagong11 ) "

SQL=SQL&"Values ('"&rsjbidx&"','"&goidx&"', '"&goprice&"', '"&sidx&"', '"&barlistprice&"', '"&QTYIDX&"', '"&QTYprice&"', "
SQL=SQL&"'"&sjbqty&"', '"&sjbwide&"', '"&sjbwidePRICE&"', '"&sjbhigh&"', '"&sjbhighPRICE&"', '"&sjbbanghyang&"', '"&sjbwitch&"', '"&sjbbigo&"', "
SQL=SQL&"'"&glidx&"', '"&glprice&"', '"&sangBUIDX&"', '"&sangbuprice&"', '"&pidx&"', '"&pprice&"', '"&rHABUIDX&"', '"&rHAbuprice&"', "
SQL=SQL&"'"&kyidx1&"', '"&kyprice1&"', '"&kyidx2&"', '"&kyprice2&"', '"&sjbkey3&"', '"&sjbkey4&"', '"&kyidx3&"', '"&kyprice3&"', '"&kyidx4&"', '"&kyprice4&"', '"&sjbkey7&"', '"&sjbkey8&"', "
SQL=SQL&"'"&tagongidx1&"', '"&tagongprice1&"', '"&sjbtagong2&"', '"&sjbtagong3&"', '"&sjbtagong4&"', '"&sjbtagong5&"', "
...
SQL=SQL&"'"&hingeidx3&"', '"&hingeprice3&"', '"&hingeidx4&"', '"&hingeprice4&"', '"&sjbhingeup2&"', '"&sjbhingeup3&"', "
SQL=SQL&"'"&sjbkyukja1&"', '"&kyukjaprice&"', '"&sjbkyukja2&"', '"&sjbkyukja3&"', '"&sjbkyukja4&"', '"&sjbkyukja5&"', '"&sjbkyukja6&"', '"&sjbkyukja7&"', '"&sjbkyukja8&"', "
SQL=SQL&"'"&rsjaidx&"', '"&rcidx&"','"&sujuinmoneyidx&"', "
SQL=SQL&"'"&sjwondanga&"', '"&sjchugageum&"', '"&sjgonggeumgaaek&"', '"&sjDCdanga&"', "
SQL=SQL&"'"&sjseaek&"', '"&sjdanga&"', '"&sjgeumaek&"', "
...
Dbcon.Execute (SQL)
'response.end
response.write "<script>location.replace('sujuin.asp?cidx="&rcidx&"&sjaidx="&rsjaidx&"&sjbidx="&rsjbidx&"&goidx="&goidx&"&sidx="&sidx&"');</script>"

else 

SQL = "UPDATE tk_sujub SET  goidx = '" & goidx & "', goprice = '" & goprice & "', sidx = '" & sidx & "', barlistprice = '" & barlistprice & "',QTYIDX = '" & QTYIDX & "', QTYprice = '" & QTYprice & "', "
...
SQL = SQL & "sjbkyukja1 = '" & sjbkyukja1 & "', kyukjaprice = '" & kyukjaprice & "', sjbkyukja2 = '" & sjbkyukja2 & "', sjbkyukja3 = '" & sjbkyukja3 & "', sjbkyukja4 = '" & sjbkyukja4 & "', sjbkyukja5 = '" & sjbkyukja5 & "', sjbkyukja6 = '" & sjbkyukja6 & "', sjbkyukja7 = '" & sjbkyukja7 & "', sjbkyukja8 = '" & sjbkyukja8 & "', sjaidx = '" & rsjaidx & "', cidx = '" & rcidx & "', sujuinmoneyidx = '" & sujuinmoneyidx & "', "
