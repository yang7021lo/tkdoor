...
<!-- 내용 입력 시작 -->  
        <div class="row card mb-2" style="height:950px; display: flex; justify-content: center; align-items: center;">
            <iframe name="hide" width="80%" height="80%" src="/mes/pummok_Busok_ST_item.asp" style="border: 0;"></iframe> 
        </div>
<!-- 내용입력 끝 -->
    </div>
</main>                          
