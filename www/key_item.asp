                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-inline ms-auto me-0 -3 my-2 my-md-0" method="post" action="key_item.asp" name="form1">
                                <div class="mb-3">
            ...
            <div class="card mb-4 card-body">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th scope="col">코드</th>
                        <th scope="col">축약어</th>
                        <th scope="col">키 품명</th>
                        <th scope="col">키 단가</th>
                    ...
                    <tbody class="table-group-divider">
                        ...
                        SQL=SQL&" Where(kycode like '%"&request("SearchWord")&"%'  or kyshorten like '%"&request("SearchWord")&"%'  or kyname like '%"&request("SearchWord")&"%'  ) "
                        End If 
                        SQL=SQL&" Order by kyidx desc "
