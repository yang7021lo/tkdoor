...
<!-- 제목 나오는 부분 끝-->
<!-- input 형식 시작--> 
<form name="barasi" action="brskdb0305.asp" method="post">
<% if part="update" then %>
...
<% end if %>
            <div class="col-12">
                <div class="input-group mb-3">
                    ...
                    <% if rbaidx<>"" then %>
                    <button type="button" class="btn btn-success" Onclick="location.replace('brsk0305.asp');">신규</button>  
                    <% end if %> 
                </div>
            ...
            <div class="row">
                <div class="card card-body mb-4">
                    ...
                    %>
                        <tr>
                            <td><%=baidx%></td>
                            <td><a href="brsk0305.asp?rbaidx=<%=baidx%>&part=update"><% if bastatus="0" then response.write "<s>" end if%><%=baname%><% if bastatus="0" then response.write "</s>" end if%></a></td>
                        </tr>
                    <%
                    Rs.movenext
                    Loop
...
<!-- 절곡설정 시작-->
      ...
      <div class="row">
<form name="barasisub" action="brskdb0305.asp" method="post">
...
<button type="button" class="btn <%=btn_text%> btn-sm"><%=accsize%></button>
            ...
            %>
                    <td>
<a href="brsk0305.asp?rbaidx=<%=rbaidx%>&rbasidx=<%=basidx%>"><%=bassize%></a>
                    </td>
                    <td></td>
            <%
            Rs.movenext
