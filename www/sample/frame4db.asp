...
SQL="Select max(fidx) From tk_frame "
    ...
    End If
    Rs.Close
response.write "<script>location.replace('frame4.asp?rfidx="&rfidx&"');</script>"
end If
'================================
'프레임 생성 끝
...
SQL=" Insert into tk_frameSub (fidx, xi, yi, wi, hi, fmidx, fwdate) "
SQL=SQL&" Values ('"&rfidx&"','"&axi&"','"&ayi&"','"&awi&"','"&ahi&"','"&C_midx&"', getdate()) "
Response.write (SQL)&"<br>"
Dbcon.Execute (SQL)
'Response.end
response.write "<script>location.replace('frame4.asp?rfidx="&rfidx&"');</script>"
