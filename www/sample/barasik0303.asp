            ...
            <div class="row">
                <div class="card card-body mb-4">
                    ...
                    %>
                        <tr>
                            <td><%=baidx%></td>
                            <td><a href="barasik0303.asp?rbaidx=<%=baidx%>&part=update"><% if bastatus="0" then response.write "<s>" end if%><%=baname%><% if bastatus="0" then response.write "</s>" end if%></a></td>
                        </tr>
                    <%
                    Rs.movenext
                    Loop
...
<!-- 절곡설정 시작-->
      ...
      <div class="row">
<form name="barasisub" action="barasikdb0303.asp" method="post">
...
%>
            ...
            <div class="card col-3">
              <div class=" text-start ms-0" style="width:100%;padding:10 5 5 5;">
...
<button type="button" class="btn <%=btn_text%> btn-sm"><%=accsize%></button>
            ...
            %>
                    <td>
<a href="barasik0303.asp?rbaidx=<%=rbaidx%>&rbasidx=<%=basidx%>"><%=bassize%></a>
                    </td>
                    <td></td>
            <%
            Rs.movenext
            ...
            %>
                    <td>
<a href="barasik0303.asp?rbaidx=<%=rbaidx%>&rbasidx=<%=basidx%>"><%=idv%></a>
                    </td>
                    <td></td>
            <%
            Rs.movenext
