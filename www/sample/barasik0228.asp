            ...
            <div class="row">
                <div class="card card-body mb-4">
                    ...
                    %>
                        <tr>
                            <td><%=baidx%></td>
                            <td><a href="barasik0228.asp?rbaidx=<%=baidx%>&part=update"><% if bastatus="0" then response.write "<s>" end if%><%=baname%><% if bastatus="0" then response.write "</s>" end if%></a></td>
                        </tr>
                    <%
                    Rs.movenext
                    Loop
...
<!-- 절곡설정 시작-->
      ...
      <div class="row">
<form name="barasisub" action="barasikdb0228.asp" method="post">
...
<!-- 가로 사이즈 시작 -->
            ...
            <input type="text" class="form-control" name="" value="<%=xsize%>" readonly>
            <input type="text" class="form-control" name="" value="<%=ysize%>" readonly>
            <input type="text" class="form-control" name="" value="<%=sx1%>" readonly>
            <input type="text" class="form-control" name="" value="<%=sx2%>" readonly>
            <input type="text" class="form-control" name="" value="<%=sy1%>" readonly>
            <input type="text" class="form-control" name="" value="<%=sy2%>" readonly>
<!-- 가로사이즈 끝 -->
<%
End if
Rs.Close
%>
            ...
            <div class="card col-3">
              <div class=" text-start ms-0" style="width:100%;padding:5 5 5 5;">
            ...
            <span class="input-group-text">진행중</span>
            <div class="card col-1">
              <div class=" text-start ms-0" style="width:=30%;padding:5 5 5 5;">

                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="final" value="0" checked>
                </div>
              </div>
            </div>
...
<button type="button" class="btn <%=btn_text%> btn-sm"><%=accsize%></button>
            ...
            %>
                    <td>
<a href="barasik0228.asp?rbaidx=<%=rbaidx%>&rbasidx=<%=basidx%>"><%=bassize%></a>
                    </td>
                    <td></td>
            <%
            Rs.movenext
