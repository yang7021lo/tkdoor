...
<!-- 제목 나오는 부분 끝-->
<!-- input 형식 시작--> 
<form name="barasi" action="brskdb.asp" method="post">
<% if part="update" then %>
...
<% end if %>
            <div class="col-12">
                <div class="input-group mb-3">
                    ...
                    <button type="button" class="btn btn-danger" Onclick="submit();">저장</button>  
                    <% if rbaidx<>"" then %>
                    <button type="button" class="btn btn-success" Onclick="location.replace('brsk.asp');">신규</button>  
                    <% end if %> 
                </div>
            ...
            <div class="row">
                <div class="card card-body mb-4">
                    ...
                    %>
                        <tr>
                            <td><%=baidx%></td>
                            <td><a href="brsk.asp?rbaidx=<%=baidx%>&part=update"><% if bastatus="0" then response.write "<s>" end if%><%=baname%><% if bastatus="0" then response.write "</s>" end if%></a></td>
                        </tr>
                    <%
                    Rs.movenext
                    Loop
...
<!-- 절곡설정 시작-->
      ...
      <div class="row">
<form name="barasisub" action="brskdb.asp" method="post">
...
<% end if %>
            ...
            <span class="input-group-text">각</span>
            <div class="card">
              <div class=" text-start ms-0" style="width:150px;padding:10 5 5 5;">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="kak" value="1" >
                    <label class="form-check-label" >뒷각</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="kak" value="2" checked>
...
<button type="button" class="btn <%=btn_text%> btn-sm"><%=accsize%></button>
            ...
            %>
                    <td>
<a href="brsk.asp?rbaidx=<%=rbaidx%>&rbasidx=<%=basidx%>"><%=bassize%></a>
                    </td>
                    <td></td>
            <%
            Rs.movenext
