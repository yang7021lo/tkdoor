    ...
    <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsehome" aria-expanded="true" aria-controls="collapsehome">
                <div class="sb-nav-link-icon"><i class="fas fa-home"></i></div>&nbsp;&nbsp;설비관리
            </button>
            </h2>
            ...
            <div class="accordion-body">
                <a class="nav-link" href="h_idpw.asp">설비정보등록</a>
                <a class="nav-link" href="h_takeoff.asp">설비점검/정비등록</a>
                <a class="nav-link" href="h_order.asp">설비이력현황</a>   
                <a class="nav-link" href="h_glass.asp">설비정보분석</a>   
                <a class="nav-link" href="h_tranglass.asp">설비고장문자전송이력</a>   
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseout" aria-expanded="false" aria-controls="collapseout">
                <div class="sb-nav-link-icon"><i class="fas fa-chalkboard-teacher"></i></div>&nbsp;&nbsp;품질관리
            </button>
            </h2>
            ...
            <div class="accordion-body">
                <a class="nav-link" href="out_list.asp">제품불량유형등록</a>
                <a class="nav-link" href="out_listup.asp">생산불량정보관리</a>
                <a class="nav-link" href="out_bea.asp">생산불량현황 </a>
                <a class="nav-link" href="out_chango.asp">불량종합분석</a>
