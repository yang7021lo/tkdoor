    ...
    <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseorder" aria-expanded="false" aria-controls="collapseorder">
                <div class="sb-nav-link-icon"><i class="fas fa-robot"></i></div>&nbsp;&nbsp;기초관리
            </button>
            </h2>
            ...
            <div class="accordion-body">
                <a class="nav-link" href="/TNG1/AL_12T_A.asp">거래처등록</a>
                <a class="nav-link" href="/mes/sujunow.asp">거래처별설정</a>
                <a class="nav-link" href="/mes/sujunow2.asp">품목분류등록</a>
                <a class="nav-link" href="w_error.asp?listgubun=one&subgubun=one4">품목등록</a>
                <a class="nav-link" href="w_error_now.asp?listgubun=one&subgubun=one5">등급단가표</a>
                <a class="nav-link" href="w_sheve_into.asp?listgubun=one&subgubun=one6">자재기초코드등록</a>
                <a class="nav-link" href="w_sheve_check.asp?listgubun=one&subgubun=one7">자재기초재고등록</a>
                <a class="nav-link" href="/mes/mes3.asp">생산현황판설정</a>
            </div>
            </div>
        </div>        
        ...
        <div class="accordion-item">
            ...
            <div id="collapseorder" class="accordion-collapse collapse <%=headingOne%>" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <a class="nav-link" href="/mes/sujuin.asp">수주등록</a>
                <a class="nav-link" href="/mes/sujunow.asp">수주현황</a>
                <a class="nav-link" href="/mes/sujunow2.asp">수주진행현황</a>
                <a class="nav-link" href="w_error.asp?listgubun=one&subgubun=one4">견적등록</a>
                <a class="nav-link" href="w_error_now.asp?listgubun=one&subgubun=one5">견적현황</a>
                <a class="nav-link" href="w_sheve_into.asp?listgubun=one&subgubun=one6">B2B주문접수등록</a>
                <a class="nav-link" href="w_sheve_check.asp?listgubun=one&subgubun=one7">B2B주문현황</a>
            </div>
            </div>
        </div>
