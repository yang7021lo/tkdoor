    ...
    <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseorder" aria-expanded="false" aria-controls="collapseorder">
                <div class="sb-nav-link-icon"><i class="fas fa-robot"></i></div>&nbsp;&nbsp;매출관리
            </button>
            </h2>
            ...
            <div class="accordion-body">
                <a class="nav-link" href="/mes/sujuin.asp">매출등록</a>
                <a class="nav-link" href="/mes/sujunow.asp">미매출현황</a>
                <a class="nav-link" href="/mes/sujunow2.asp">매출거래원장</a>
                <a class="nav-link" href="w_error.asp?listgubun=one&subgubun=one4">일별매출현황</a>
                <a class="nav-link" href="w_error_now.asp?listgubun=one&subgubun=one5">월별매출현황</a>
                <a class="nav-link" href="w_sheve_into.asp?listgubun=one&subgubun=one6">수금등록</a>
                <a class="nav-link" href="w_sheve_check.asp?listgubun=one&subgubun=one7">수금등록(일자별)</a>
                <a class="nav-link" href="/mes/mes3.asp">미수금현황</a>
            </div>
            </div>
        </div>        
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseorder" aria-expanded="false" aria-controls="collapseorder">
                <div class="sb-nav-link-icon"><i class="fas fa-robot"></i></div>&nbsp;&nbsp;매입관리
            </button>
            </h2>
            <div id="collapseorder" class="accordion-collapse collapse <%=headingOne%>" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <a class="nav-link" href="/mes/sujuin.asp">매입발주등록</a>
                <a class="nav-link" href="/mes/sujunow.asp">매입입고등록</a>
                <a class="nav-link" href="/mes/sujunow2.asp">미입고현황</a>
                <a class="nav-link" href="w_error.asp?listgubun=one&subgubun=one4">매입거래원장</a>
                <a class="nav-link" href="w_error_now.asp?listgubun=one&subgubun=one5">일별매입현황</a>
                <a class="nav-link" href="w_sheve_into.asp?listgubun=one&subgubun=one6">지급등록</a>
                <a class="nav-link" href="w_sheve_check.asp?listgubun=one&subgubun=one7">미지급현황</a>
            </div>
            </div>
        </div>
<!-- 
        <div class="accordion-item">
            ...
            <div id="collapseorder" class="accordion-collapse collapse <%=headingOne%>" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <a class="nav-link" href="/mes/sujuin.asp">작업의뢰등록</a>
                <a class="nav-link" href="/mes/sujunow.asp">작업의뢰현황</a>
