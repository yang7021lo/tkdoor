    ...
    <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsehome" aria-expanded="true" aria-controls="collapsehome">
                <div class="sb-nav-link-icon"><i class="fas fa-home"></i></div>&nbsp;&nbsp;채유정
            </button>
            </h2>
            ...
            <div class="accordion-body">
                <a class="nav-link" href="/cyj/corplist.asp">업체리스트(시작)</a>
                <a class="nav-link" href="/cyj/memlist.asp">사용자정보</a>
                ...
                <a class="nav-link" href="/report/remainlist.asp">성적서</a>   
                <a class="nav-link" href="h_data_cata.asp">카다록</a>   
                <a class="nav-link" href="/paint_itemin.asp">색상표</a>   
                <a class="nav-link" href="/cyj/corpsetting.asp">거래처 단가설정</a>   
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseorder" aria-expanded="false" aria-controls="collapseorder">
                <div class="sb-nav-link-icon"><i class="fas fa-robot"></i></div>&nbsp;&nbsp;오은숙
            </button>
            </h2>
            ...
            <div class="accordion-body">
                <a class="nav-link" href="/ooo/advice/adviceall.asp">전체상담</a>
                <a class="nav-link" href="/ooo/advice/advicem.asp">수신함</a>
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsemat" aria-expanded="false" aria-controls="collapsemat">
                <div class="sb-nav-link-icon"><i class="fas fa-chalkboard-teacher"></i></div>&nbsp;&nbsp;김호영
            </button>
            </h2>
            ...
            <div class="accordion-body">
                <a class="nav-link" href="/khy/khorder.asp">자재등록이다다다다</a>
