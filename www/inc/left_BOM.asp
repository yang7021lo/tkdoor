    ...
    pointer-events: none;  /* 클릭 무력화 */
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-body">
                <a class="nav-link" href="/Door/Engine/test.asp">test</a>
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-body">
                <a class="nav-link" href="/TNG_bom/bom_master_popup.asp">bom_master_popup</a>
                <a class="nav-link" href="/TNG_bom/bom_aluminum_popup.asp">bom_aluminum_popup</a>
                <a class="nav-link" href="/TNG_bom/bom_mold_popup.asp">bom_mold_popup</a>
