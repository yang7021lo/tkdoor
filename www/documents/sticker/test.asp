  ...
  Do While Not rs.EOF
    ...
    If Not (rs1.BOF Or rs1.EOF) Then
      Do While Not rs1.EOF
            ...
            Response.Write "제품명: " & framename & "<br>"
            Response.Write "거래처: " & cname & "<br>"
            Response.Write "수주번호: " & sjnum & "<br>"
            Response.Write "현장주소: " & cgaddr & "<br>"
            Response.Write "재질: " & qtyname & "<br>"
            Response.Write "도장: " & pname & "<br>"
            Response.Write "수량: " & quan & "<br>"
            Response.Write "위치: " & loc1+loc2 & "<br>"
            Response.Write "자재부속번호: " & zfksidx & "<br>"
            Response.Write "총계: "        & cnt     & "<br>"
            Response.Write "파트번호: "    & sunno   & "<br>"
