                ...
                <div class="canvas-container" id="svgCanvas" style="width: 100%; height: 100%; padding: 0px;">
                    <div class="svg-container">
                        ...
                        if fstype="2" then %>
                            ...
                            onclick="location.replace('TNG1_B_suju.asp?sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=fkidx%>&sjb_idx=<%=sjb_idx%>&fksidx=<%=fksidx%>');" data-value="id=<%=fksidx%>;width=<%=yblength%>;height=<%=ysize%>;"/> 
                        <% else 
