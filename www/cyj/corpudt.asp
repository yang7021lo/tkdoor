...
<%
    ...
    SQL=SQL&" , A.calevel, A.cslevel, A.csylevel, A.cfax, A.ctel, A.ctel2, A.accnumb, A.bankname, A.accname, A.cgetmoney "
...
<input type="hidden" name="cidx"  value="<%=cidx%>">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <input type="text" class="form-control" id="accnumb" name="accnumb" value="<%=raccnumb%>" placeholder="계좌번호 입력" style="width: 100%; display: inline;">
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control" name="bankname" id="bankname" placeholder="거래 은행을 입력하세요." value="<%=rbankname%>">
            </div>

            <div class="col-md-4">
                <input type="text" class="form-control" name="accname" id="accname"placeholder="입금자명을 입력하세요"  value="<%=raccname%>">
            </div>
        </div> 
    ...
    <div class="py-2 mb-3 container text-start  card card-body">  
            ...
            <div class="col-md-2 mb-3">
                <label><b>출고</b></label>
                    <select class="form-select" id="cmove" name="cmove">
                        ...
                        <option value="12" <% if rcmove="12" then Response.write "selected" end if %>>제주창고</option>
                    </select>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2 mb-3">
                <label for="name"><b>도어등급</b></label>
                    <select class="form-select" id="cdlevel" name="cdlevel">
                        <option value="0" <% if rcdlevel="0" then Response.write "selected" end if %>>미지정</option>    
                        <option value="1" <% if rcdlevel="1"  or rcdlevel="" then Response.write "selected" end if %>>10만(기본)</option>                        
                        ...
                        <option value="6" <% if rcdlevel="6" then Response.write "selected" end if %>>1000*2400</option>
                    </select>
            </div>
            ...
            <div class="col-md-2 mb-3">
                <label for="name"><b>프레임등급</b></label>
                    <select class="form-select" id="cflevel" name="cflevel">
                        <option value="0" <% if rcflevel="0" or rcflevel="" then Response.write "selected" end if %>>기본</option>  
                        <option value="1" <% if rcflevel="1" then Response.write "selected" end if %>>A등급(전체 10%DC)</option>                        
                        <option value="2" <% if rcflevel="2" then Response.write "selected" end if %>>B등급(스텐 보급만 10%DC)</option>
                        <option value="3" <% if rcflevel="3" then Response.write "selected" end if %>>C등급(자동전체 10%DC)</option>
                        <option value="4" <% if rcflevel="4" then Response.write "selected" end if %>>D등급(알미늄자동만 10%DC)</option>
                        <option value="5" <% if rcflevel="5" then Response.write "selected" end if %>>E등급(전체 10% 업)</option>
                    </select>
            </div>
            <div class="col-md-2 mb-3">
            ...
            <div class="col-md-2 mb-3">
                <label for="name"><b>입금후출고</b></label>
                <select class="form-select" id="cgetmoney" name="cgetmoney">
                        <option value="0" <% if rcgetmoney="0" then Response.write "selected" end if %>>해당사항 없음</option>                        
                        <option value="1" <% if rcgetmoney="1" then Response.write "selected" end if %>>입금후 출고</option>
                    </select>
            </div>
        </div>
        <div class="row">
