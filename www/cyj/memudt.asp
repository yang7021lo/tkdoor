...
<!-- 거래처 기본정보 include 끝 --> 
    ...
    %>
       ...
       <option value="<%=cidx%>" <% if cidx=rcidx then Response.write "selected" end if %> ><%=cname%></option>
    <%
    Rs.MoveNext 
    Loop 
    End If 
    ...
    %>
         ...
         <div class="input-group mb-3">
           ...
           <input type="text" class="form-control" name="mname" value="<%=rmname%>">
         </div>
         <div class="input-group mb-3">
           <span class="input-group-text" style="width:80px;">직책</span>
           <input type="text" class="form-control" name="mpos" value="<%=rmpos%>">
         </div>
         <div class="input-group mb-3">
           <span class="input-group-text" style="width:80px;">전화번호</span>
           <input type="text" class="form-control" name="mtel" onkeyup="inputPhoneNumber(this);" value="<%=rmtel%>"  maxlength="13">
         </div>
         <div class="input-group mb-3">
           <span class="input-group-text" style="width:80px;">휴대폰</span>
           <input type="text" class="form-control" name="mhp" value="<%=rmhp%>" onkeyup="inputPhoneNumber(this);" maxlength="13">
    
         </div>
         <div class="input-group mb-3">
           <span class="input-group-text" style="width:80px;">팩스</span>
           <input type="text" class="form-control" name="mfax" value="<%=rmfax%>" onkeyup="inputPhoneNumber(this);" maxlength="13">
         </div>
         <div class="input-group mb-3">
           <span class="input-group-text" style="width:80px;">이메일</span>
           <input type="text" class="form-control" name="memail" value="<%=rmemail%>">
         </div>
