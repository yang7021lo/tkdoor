                ...
                <tbody>
                    ...
                    %>
                     <tr>
                        ...
                        <td><%=mname%></td>
                        <td><%=memail%></td>
                        <td><button type="button" class="btn btn-outline-danger" Onclick="location.replace('emailselectdeldb.asp?SearchWord=<%=SearchWord%>&snidx=<%=snidx%>&esidx=<%=esidx%>&udt=1');">삭제</button></td>
                    </tr>
                    <%
                    Rs.movenext
                    Loop
                ...
                <tbody>
                    ...
                    %>
                     <tr>
                        ...
                        <td><%=mmname%></td>
                        <td><%=cemail%></td>
                        <td><button type="button" class="btn btn-outline-success" Onclick="location.replace('emailselectdb.asp?SearchWord=<%=SearchWord%>&snidx=<%=snidx%>&cidx=<%=mcidx%>&memail=<%=cemail%>&mname=<%=mmname%>&udt=1');">추가</button></td>
                    </tr>
                    <%
                    Rs.movenext
                    Loop
                    ...
                    %>
                     <tr>
                        ...
                        <td><%=mname%></td>
                        <td><%=memail%></td>
                        <td><button type="button" class="btn btn-outline-success" Onclick="location.replace('emailselectdb.asp?SearchWord=<%=SearchWord%>&snidx=<%=snidx%>&cidx=<%=cidx%>&memail=<%=memail%>&midx=<%=midx%>&mname=<%=mname%>&udt=1');">추가</button></td>
                    </tr>
                    <%
                    Rs.movenext
                    Loop
