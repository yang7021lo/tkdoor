...
<%
    ...
    if snidx="" then
        SQL="insert into tk_reportsend (snmidx) values ('"&c_midx&"')"
        Dbcon.Execute (SQL)
    end if
...
<script>
    ...
    function smwindow4(str){
        newwin=window.open(str,'_blank', 'scrollbars=yes,menubar=no,statusbar=no,status=no,width=1000,height=800,top=400,left=400');
        newwin.focus();
    }
</script>
                    ...
                    <div class=" py-5 container text-center card card-body">
                        ...
                        <form name="frmMain" action="sendemaildb.asp" method="post">
                            ...
                            <div class="input-group mb-2">
                                <button type="button" class="btn btn-outline-secondary" onclick="smwindow3('mailtemplist.asp');">임시저장 불러오기</button>
                            </div>
                            ...
                            <div class="input-group mb-2">
                                ...
                                <div class="card form-control">
                                    <table id="datatablesSimple" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                                            <tr>
                                                                <td><%=cname%></td>
                                                                <td><button type="button" class="btn btn-outline-danger" Onclick="location.replace('rsendcorpselectdeldb.asp?snsidx=<%=snsidx%>&snidx=<%=snidx%>&cidx=<%=cdix%>');">삭제</button></td>
                                                            </tr>
                                            <%
                                            Rs.movenext
                                            Loop
                                    ...
                                    <div class="container item-left">
                                        <button type="button" class="btn btn-outline-success" onclick="smwindow2('rsendcorpselect.asp?snidx=<%=snidx%>');">+&nbsp;거래처 추가</button>
                                    </div>                                    
                                    </div>
                            </div>
                                ...
                                <div class="card form-control">
                                    <table id="datatablesSimple" class="table table-hover">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    <td><%=rname%><br>(<%=ron%>)</td>
                                                    <td><button type="button" class="btn btn-outline-danger" onclick="location.replace('rsendselectdeldb.asp?snsidx=<%=snsidx%>&ridx=<%=ridx%>&snidx=<%=snidx%>&cidx=<%=cidx%>');">삭제</button></td>
                                                </tr>
                                    ...
                                    <div class="container item-left">
                                        <button type="button" class="btn btn-outline-success" onclick="smwindow4('rsendselect.asp?snidx=<%=snidx%>');">+&nbsp;성적서 추가</button>
                                    </div>
                            </div>
                            ...
                            <div class="input-group mb-2">
                                ...
                                <div class="card form-control">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                                <tr>
                                                    <td><%=rgname%></td>
                                                    <td><%=rgfile%></td>
                                                    <td><button type="button" class="btn btn-outline-danger" Onclick="location.replace('rsendgselectdeldb.asp?snsidx=<%=snsidx%>&rgidx=<%=rgidx%>&snidx=<%=snidx%>');">삭제</button></td>
                                                </tr>
                                            <%
                                            Rs.movenext
                                            Loop
                                    ...
                                    <div class="container item-left">
                                        <button type="button" class="btn btn-outline-success" onclick="smwindow2('rsendgselect.asp?snidx=<%=snidx%>');">+&nbsp;그룹 추가</button>
                                    </div>
                            </div>
                                    ...
                                    <table id="datatablesSimple" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                                <tr>
                                                    <td><%=efname%></td>
                                                    <td><button type="button" class="btn btn-outline-danger" Onclick="location.replace('emailatfiledeldb.asp?efidx=<%=efidx%>&snidx=<%=ksnidx%>');">삭제</button></td>
                                                </tr>
                                            <%
                                            Rs.movenext
                                            Loop
                            ...
                            <div class="card form-control border-0">
                                <div class="d-flex">
                                    <div class="input-group mb-3">
                                        ...
                                        <button type="button" class="btn btn-outline-secondary" Onclick="location.replace('rsenddeldb.asp?snidx=<%=snidx%>');">저장하지 않고 나가기</button>      
                                    </div>
                                    <div class="input-group mb-3 float-right justify-content-end">
                                        <button type="button" class="btn btn-outline-danger" Onclick="location.replace('sendmailtempsave.asp?snidx=<%=snidx%>');">임시저장</button>
                                    </div>           
                                </div>
                            </div> 
