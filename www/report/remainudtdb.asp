...
uploadform.DefaultPath=DefaultPath_report
    ...
    SQL="Update tk_member set ron='"&ron&"', rname='"&rname&"', ruse='"&ruse&"', rtdate='"&rtdate&"' where ridx='"&ridx&"' "
    'Respose.write(SQL)&"<br>
    Dbcon.Execute (SQL)

response.write "<script>alert('품목이 등록되었습니다');location.replace('remainlist.asp?ridx="&ridx&"');</script>"
%>
