...
<!--화면시작-->
    <div class="py-3 container text-center">
        ...
        <div class="input-group mb-3">
            ...
            <div class="btn">
                <button type="button" class="btn btn-primary" Onclick="location.replace('shrsingdb.asp?ridx=<%=ridx%>&rftype=<%=ftype%>&rfidx=<%=rfidx%>&clickaacfidx=<%=clickaacfidx%>&clickacfidx=<%=clickacfidx%>')"><%=rfname%></button>
            </div>
        ...
        <div class="input-group mb-3">
            ...
            <div class="btn">
                <button type="button" class="btn btn-danger" Onclick="location.replace('shrsingdeldb.asp?ridx=<%=ridx%>&rsidx=<%=rsidx%>&clickaacfidx=<%=clickaacfidx%>&clickacfidx=<%=clickacfidx%>')"><%=fname%>&nbsp;삭제</button>
            </div>
