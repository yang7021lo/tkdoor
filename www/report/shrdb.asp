...
Response.Write "<script>opener.location.replace('remain2.asp?ridx="&ridx&"&clickacfidx="&clickacfidx&"&clickaacfidx="&clickaacfidx&"');location.replace('shr.asp?ridx="&ridx&"&ftype="&rftype&"&clickacfidx="&clickacfidx&"&clickaacfidx="&clickaacfidx&"')</script>"
%>
