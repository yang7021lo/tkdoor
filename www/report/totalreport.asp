<!--
주요 테이블
tk_reportsend (전송된 메일 메인 DB)

snidx:메일 idx
sndate:발송 날짜
snreadstatus:조회수(status라고 되어있지만 조회여부가 아닌 조회수임)
sndownloadstatus:미사용
sndownloadcount:미사용
snrgidx:미사용
snridx:미사용
sncidx:미사용
...
<!--
서브 테이블
tk_reportsendSub -> 한 메일 안의 여러 성적서를 연결시켜줌

snsidx:tk_reportsendgSub idx
snidx:메일 idx
ridx:미사용
rgidx:성적서 그룹 idx

tk_reportsendgSub -> 한 메일 안의 여러 성적서 그룹을 연결시켜줌

snsidx:tk_reportsendSub idx
snidx:메일 idx
ridx:성적서 idx
rgidx:미사용
rfixtop:미사용

tk_reportsendcorpSub -> 한 메일 안의 여러 거래처를 연결시켜줌

snsidx:tk_reportsendcorpSub idx
snidx:메일 idx
cidx:거래처 idx
cname:거래처명
-->
                    ...
                    <div class=" py-5 container text-center">
                        <div class="input-group mb-1">
                            ...
                            <div class="col-4 text-end">
                                ...
                                <button type="button" class="btn btn-outline-danger" Onclick="smwindow('sendmail.asp?cidx=<%=cidx%>');">성적서 전송</button>    
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">  
                                        <form class="form-inline ms-auto me-0 -3 my-2 my-md-0" method="post" action="totalreport.asp" name="form1">
                                            <div class="mb-3">
...
SQL=SQL&" Where A.sndate Is Not NULL and snsendstatus='1' "
