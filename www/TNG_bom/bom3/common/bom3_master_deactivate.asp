...
cnt_material = getCnt("SELECT COUNT(*) FROM bom3_material WHERE master_id=" & master_id & " AND is_active=1")
cnt_title = getCnt("SELECT COUNT(*) " & _
  ...
  <div class="card shadow-sm">
    <div class="card-body">
      ...
      <div class="mt-4 d-flex gap-2">
        <a href="bom3_deactivate_apply.asp?master_id=<%=master_id%>"
           class="btn btn-danger">
          연결 항목 비활성화 진행
        </a>
        <a href="../bom3_main.asp"
