...
Dbcon.Execute _
"INSERT INTO bom2_mold (" & _
" master_id, mold_name, is_active, midx, meidx, cdate" & _
") VALUES (" & _
 newMasterId & ", '-', 1, " & c_midx & ", " & c_midx & ", GETDATE()" & _
")"

Dbcon.Execute _
"INSERT INTO bom2_surface (" & _
" master_id, surface_name, is_active, midx, meidx, cdate" & _
") VALUES (" & _
 newMasterId & ", '-', 1, " & c_midx & ", " & c_midx & ", GETDATE()" & _
")"

Dbcon.Execute _
"INSERT INTO bom2_length (" & _
" master_id, bom_length, is_active, midx, meidx, cdate" & _
") VALUES (" & _
 newMasterId & ", 0, 1, " & c_midx & ", " & c_midx & ", GETDATE()" & _
")"

Dim sqlTitle
sqlTitle = "INSERT INTO bom2_list_title (" & _
           "master_id, title_name, density, type_id, is_active, midx, meidx, cdate" & _
           ") VALUES (" & _
           newMasterId & ", " & _
           "N'거래처', " & _
           "NULL, " & _
