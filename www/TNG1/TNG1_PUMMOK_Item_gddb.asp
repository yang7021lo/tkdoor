...
if part="delete" then 
    ...
    response.write "<script>location.replace('TNG1_PUMMOK_Item_gd.asp?gotopage=" & gotopage & "&SearchWord="&rSearchWord&"');</script>"
else 
    if rsJB_IDX="0" then 
        ...
        response.write "<script>location.replace('TNG1_PUMMOK_Item_gd.asp?gotopage=" & gotopage & "&SJB_IDX="&SJB_IDX&"&SearchWord="&rSearchWord&"#"&SJB_IDX&"');</script>"
    else
       ...
       ' Response.write(SQL) & "<br>"
         'Response.END
        Dbcon.Execute(SQL)
        response.write "<script>location.replace('TNG1_PUMMOK_Item_gd.asp?gotopage=" & gotopage & "&SJB_IDX="&rSJB_IDX&"&SearchWord="&rSearchWord&"#"&rSJB_IDX&"');</script>"
    end if
end if
