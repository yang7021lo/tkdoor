    ...
    printBtn.addEventListener('click', function(){
      if (isUnsupportedWebview()) {
        ...
        window.print();
          ...
          <button class="btn btn-dark no-print order-btn" onclick="alert('기능구현중')">발주 요청&nbsp&nbsp✅</button>
          ...
          <div class="section d-flex justify-content-between align-items-start">
            ...
            <div class="total-card">
              <img class="corp-stamp" width="100%"
                src="https://media.discordapp.net/attachments/1176516578616029254/1387307988511096865/1.png?ex=685cdebf&is=685b8d3f&hm=0018e32545a6e6f56b0cf038fa39e36cd6e24ccad45b7add3315a2c617d82873&=&format=webp&quality=lossless&width=2784&height=1310">
            </div>
          </div>
            ...
            <div class="d-none d-md-block">
              <div class="card mb-4 shadow-sm">
                ...
                <div class="card-header text-black d-flex justify-content-between">
                  <div class="parent-title"><strong>No. 1</strong> 헤어라인1.2+지정색도장</div>
              ...
              <div class="card mb-4 shadow-sm">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item p-2">
                    <div class="fw-semibold mb-2">1. ASD1 135×45 단열AL자동프레임</div>
