                  ...
                  <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-header text-black">
                      <div class="d-flex justify-content-between">
                        <div class="parent-title"><strong>No. <%=i%></strong> <%= sjb_type_name %> (<%=mwidth%>×<%=mheight%>)</div>
                        <!-- 작은 속성 카드 블록 예시 -->
                      ...
                      <table class="table table-bordered table-sm mb-0 text-center">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><%=mheight%></td>
                            <td><%=quan%></td>
                            <td><%=FormatCurrency(sjsprice)%></td>
                            <td><%=FormatCurrency(fprice)%></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
