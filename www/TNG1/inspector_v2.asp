...
<head>
  ...
  <script>
    ...
    function lengthreset(){
      ...
      {
          location.href="inspector_v2.asp?gubun=lengthreset&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>"
      }
    }
    function del(){
      if (confirm("선택한 부속을 삭제 하시겠습니까?"))
      {
          location.href="inspector_v2.asp?gubun=del&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>"
      }
    }
    function framedel(){
      if (confirm("프레임의 모든 정보를 삭제 하시겠습니까?"))
      {
          location.href="inspector_v2.asp?gubun=framedel&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>"
      }
    }    
    ...
    function chg(whichi_fix, doorwhichi){
      ...
      if (result) {
        location.href="inspector_v2.asp?gubun=chg&mode=auto&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>&whichi_fix="+whichi_fix+"&doorwhichi="+doorwhichi;
      } else {
        location.href="inspector_v2.asp?gubun=chg&mode=manual&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>&whichi_fix="+whichi_fix+"&doorwhichi="+doorwhichi;
      }
    }
    ...
    function handleChange(afksidx) {
      location.href="inspector_v2.asp?sjidx=<%=rsjidx%>&sjcidx=<%=rsjcidx%>&sjsidx=<%=rsjsidx%>&sjb_idx=<%=rsjb_idx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>&fksidx="+afksidx.value;
...
<div class="d-flex mb-1">
  <div class="col-8">
    ...
    Do while not Rs.EOF
      ...
      ayi=Rs(6)
    %>  
      <option value="<%=afksidx%>" <% if Cint(afksidx)=Cint(rfksidx) then response.write "selected" end if %>>[<%=right(afksidx,3)%>]<%=awhichi_fixname%>(<%=axi%>&times;<%=ayi%>)</option>
    <%
      Rs.movenext
      Loop
      End if
  ...
  <form id="lengthForm" name="lengthForm" action="inspector_v2.asp" method="POST">
...
<!-- -->
<form id="myForm1" method="get" action="inspector_v2.asp" class="d-flex align-items-center gap-2">
...
<div class="btn-group-wrap">
  ...
  <div class="btn-group-custom">
    ...
    Do while not Rs.EOF
      ...
      chi=Rs(8)
    %>  
      <option value="<%=cfksidx%>" <% if Cint(cfksidx)=Cint(rfksidx) then response.write "selected" end if %>>[<%=right(cfksidx,3)%>]<%=cwhichi_fixname%>(<%=cxi%>&times;<%=cyi%>|<%=cwi%>|<%=chi%>|)</option>
    <%
      Rs.movenext
      Loop
      End if
  ...
  <!-- 그룹 2 -->
<form id="myForm" method="get" action="inspector_v2.asp" class="d-flex align-items-center gap-2">
...
<input type="hidden" name="buttonValue" id="buttonValue">
  <div class="btn-group-custom">
    ...
    <div class="btn-row">
      ...
      <button type="button" class="btn btn-outline-success" onclick="">자재추가</button>
...
Response.write "rbuttonValue:"&rbuttonValue1&"<br>"
...
End If
Response.write "<script>window.opener.location.replace('TNG1_B_suju_quick.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"');location.replace('inspector_v2.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"&sjb_type_no="&rsjb_type_no&"&greem_f_a="&rgreem_f_a&"');</script>"
...
Response.write "<script>window.opener.location.replace('TNG1_B_suju_quick.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&zfksidx&"');location.replace('inspector_v2.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&zfksidx&"&sjb_type_no="&rsjb_type_no&"&greem_f_a="&rgreem_f_a&"');</script>"
...
Rs.close
  ...
  'response.end
  response.write "<script>location.replace('inspector_v2.asp?gubun=up1date&optionType="&roptionType&"&sjcidx="&rsjcidx&"&sjidx="&rsjidx&"&sjsidx="&rsjsidx&"&sjb_idx="&rsjb_idx&"&SJB_TYPE_NO="&rSJB_TYPE_NO&"&greem_f_a="&rgreem_f_a&"&fkidx="&rfkidx&"&fksidx="&fksidx&"&xi="&xi&"&yi="&yi&"&wi="&wi&"&hi="&hi&"&alength="&alength&"&blength="&blength&"')</script>"
...
Elseif gubun="lengthreset" then 
  ...
  REsponse.write "<script>location.replace('inspector_v2.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"&sjb_type_no="&rsjb_type_no&"&greem_f_a="&rgreem_f_a&"');</script>"
...
'기존 상부남마유리를 삭제
  ...
  Response.write "<script>window.opener.location.replace('TNG1_B_suju_quick.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"');location.replace('inspector_v2.asp?sjidx="&rsjidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"&sjb_type_no="&rsjb_type_no&"&greem_f_a="&rgreem_f_a&"');</script>"
