...
SQL="Select max(fidx) From tk_frame "
    ...
    End If
    Rs.Close
response.write "<script>location.replace('tng1_greemlist3_frame.asp?rfidx="&rfidx&"');</script>"
end If
'================================
'프레임 생성 끝
...
if part="fmupdate" then 
  ...
  response.write "<script>location.replace('tng1_greemlist3_frame.asp?rfidx="&rfidx&"&rfsidx="&rfsidx&"');</script>"
end if
'================================
'부속 수정하기 끝
