                                    ...
                                    <div class="canvas-container" id="svgCanvas" style="width: 100%; height: 100%; padding: 0px;">
                                        <div class="svg-container" style="width: 100%; height: 100%; padding: 0px;">
                                            ...
                                            <% else%>
                                                ...
                                                onclick="window.open(
                                                    'inspector_v5.asp?sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=fkidx%>&sjb_idx=<%=sjb_idx%>&sjb_type_no=<%=sjb_type_no%>&fksidx=<%=fksidx%>&greem_f_a=<%=rgreem_f_a%>'
                        ...
                        <div class="dropdown-content" id="custom-dropdown-3"> 
                            <div class="input-group mb-2" style="overflow-x: auto; white-space: nowrap;">
                                        ...
                                        Do while not Rs.EOF
                                            ...
                                            If CLng(rfksidx) = CLng(fksidx) Then
                                                ' 같은 fksidx → 강조(초록색)
                                                yybar_name = yybar_name & "<td style='background:#80ff80;'>" & display_name & "</td>"
                                            Else
                                                ' 다른 fksidx → 일반 td
                                                yybar_name = yybar_name & "<td>" & display_name & "</td>"
                                            End If
