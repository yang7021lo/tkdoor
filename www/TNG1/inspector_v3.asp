...
<head>
  ...
  <script>
    ...
    function lengthreset(){
      ...
      {
          location.href="inspector_v3.asp?gubun=lengthreset&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>"
      }
    }
    function del(){
      if (confirm("선택한 부속을 삭제 하시겠습니까?"))
      {
          location.href="inspector_v3.asp?gubun=del&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>"
      }
    }
    function framedel(){
      if (confirm("프레임의 모든 정보를 삭제 하시겠습니까?"))
      {
          location.href="inspector_v3.asp?gubun=framedel&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>"
      }
    }    
...
//      if (result) {
//        location.href="inspector_v3.asp?gubun=chg&mode=auto&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>&whichi_fix="+whichi_fix+"&doorwhichi="+doorwhichi;
//      } else {
//        location.href="inspector_v3.asp?gubun=chg&mode=manual&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>&whichi_fix="+whichi_fix+"&doorwhichi="+doorwhichi;
//      }
//    }
    function gpreset(){
      if (confirm("그룹 코드를 초기화 하시겠습니까?"))
      {
        location.href="inspector_v3.asp?gubun=gpreset&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>"
      }
    }
    ...
    function rowdel(){
      ...
      {
        location.href="inspector_v3.asp?gubun=rowdel&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>"
      }
    }
    function match(){
      if (confirm("선택한 자재를 기준자재와 길이를 맞추시겠습니까?"))
      {
        location.href="inspector_v3.asp?gubun=match&sjcidx=<%=rsjcidx%>&sjidx=<%=rsjidx%>&sjsidx=<%=rsjsidx%>&fkidx=<%=rfkidx%>&sjb_idx=<%=rsjb_idx%>&fksidx=<%=rfksidx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>"
      }
    }
    function chg(whichi_fix, doorwhichi){
    ...
    function handleChange(afksidx) {
      location.href="inspector_v3.asp?sjidx=<%=rsjidx%>&sjcidx=<%=rsjcidx%>&sjsidx=<%=rsjsidx%>&sjb_idx=<%=rsjb_idx%>&sjb_type_no=<%=rsjb_type_no%>&greem_f_a=<%=rgreem_f_a%>&fksidx="+afksidx.value;
...
<div class="d-flex mb-1">
  ...
  <form id="lengthForm" name="lengthForm" action="inspector_v3.asp" method="POST">
...
<!-- -->
<form id="myForm1" method="get" action="inspector_v3.asp" class="d-flex align-items-center gap-2">
...
<form id="myForm" method="get" action="inspector_v3.asp" class="d-flex align-items-center gap-2">
...
<input type="hidden" name="buttonValue" id="buttonValue">
  <div class="btn-group-custom">
    ...
    <div class="btn-row">
      <button type="button" class="btn btn-outline-success" onclick="gpreset()"><%=groupcode%></button>
...
Elseif gubun="gpreset" Then '그룹코드 초기화
  ...
  response.write (SQL)&"<br><br>"
  Dbcon.Execute SQL
  Response.write "<script>window.opener.location.replace('TNG1_B_suju_quick.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"');location.replace('inspector_v3.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"&sjb_type_no="&rsjb_type_no&"&greem_f_a="&rgreem_f_a&"');</script>"
...
Elseif gubun="add" Then '수동프레임 부속추가
  ...
  'Response.end
  Response.write "<script>window.opener.location.replace('TNG1_B_suju_quick.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&zfksidx&"');location.replace('inspector_v3.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&zfksidx&"&sjb_type_no="&rsjb_type_no&"&greem_f_a="&rgreem_f_a&"');</script>"
...
ElseIf gubun="up1date" Then 'alength, blength, xi, yi, wi, hi 단일(일괄)적용
  ...
  Rs.close
    ...
    'response.end
    response.write "<script>location.replace('inspector_v3.asp?gubun=up1date&optionType="&roptionType&"&sjcidx="&rsjcidx&"&sjidx="&rsjidx&"&sjsidx="&rsjsidx&"&sjb_idx="&rsjb_idx&"&SJB_TYPE_NO="&rSJB_TYPE_NO&"&greem_f_a="&rgreem_f_a&"&fkidx="&rfkidx&"&fksidx="&fksidx&"&xi="&xi&"&yi="&yi&"&wi="&wi&"&hi="&hi&"&alength="&alength&"&blength="&blength&"')</script>"
...
Elseif gubun="lengthreset" then 
  ...
  REsponse.write "<script>location.replace('inspector_v3.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"&sjb_type_no="&rsjb_type_no&"&greem_f_a="&rgreem_f_a&"');</script>"
...
'기존 상부남마유리를 삭제
  ...
  Dbcon.Execute (SQL)    
    ...
    End if
    Rs.Close
  Response.write "<script>window.opener.location.replace('TNG1_B_suju_quick.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"');location.replace('inspector_v3.asp?sjidx="&rsjidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&zfksidx&"&sjb_type_no="&rsjb_type_no&"&greem_f_a="&rgreem_f_a&"');</script>"
elseif gubun="del" then 
  SQL="Delete From tk_framekSub Where fksidx='"&rfksidx&"' "
  Response.write (SQL)&"<br><br>"
  Dbcon.Execute (SQL)  
  Response.write "<script>window.opener.location.replace('TNG1_B_suju_quick.asp?sjidx="&rsjidx&"&sjcidx="&rsjcidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"');location.replace('inspector_v3.asp?sjidx="&rsjidx&"&sjsidx="&rsjsidx&"&fkidx="&rfkidx&"&sjb_idx="&rsjb_idx&"&fksidx="&rfksidx&"&sjb_type_no="&rsjb_type_no&"&greem_f_a="&rgreem_f_a&"');</script>"
