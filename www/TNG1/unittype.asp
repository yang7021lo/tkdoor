...
<!-- 표 형식 시작--> 
<form id="dataForm" action="unittypedb.asp" method="POST">
                ...
                <tbody>
                    <tr>
                        <th>bfwidx // qtyco_idx</th>
                            ...
                            sql = sql & " AND unittype_bfwidx IN ('1', '2', '3')"
                            sql = sql & "AND unittype_bfwidx <> 0 "
                                            ...
                                            <%
                                                ...
                                                %>   
                                                    ...
                                                    <% else %>   
                                                        ...
                                                        onclick="location.replace('unittype.asp?unittype_qtyco_idx=<%=unittype_qtyco_idx%>&unittype_bfwidx=<%=unittype_bfwidx%>&sjbtidx=<%=sjbtidx%>&SJB_barlist=<%=rSJB_barlist%>&SJB_IDX=<%=rSJB_IDX%>&SJB_TYPE_NAME=<%=rSJB_TYPE_NAME%>&uptidx=<%=ruptidx%>#<%=ruptidx%>');"
                                                        />
                                                    <% end if %>
                                                    </td>
                                                <%
