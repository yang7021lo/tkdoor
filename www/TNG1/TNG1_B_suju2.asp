                ...
                <!-- 드롭다운 버튼 끝-->
                 <div >
                        <% if rfkidx<>"" then %>
                            ...
                            onclick="openPreviewFullscreen('<%=rsjidx%>','<%=rsjsidx%>')">
                            도어유리보기
                            </button>
                        <% end if%> 
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="input-group mb-2">  
                        ...
                        <select name="dooryn" class="form-control" id="dooryn"  onchange="handleChange_dataForm(this)">
                            <option value="0" <% If clng(zdooryn) = "0" Or Trim(zdooryn) = "" Then Response.Write "selected" %>>도어나중</option>
                    ...
                    <div class="input-group mb-2" style="gap: 8px; align-items: center;">
                        ...
                        Do while not Rs.EOF
                            ...
                            glwdate=Rs(6)
                        %>
                                        <option value="<%=gldepth%>" <% if clng(gldepth)=clng(zdoorglass_t) then %> selected <% end if %> ><%=gldepth%></option>
                        <%
                        Rs.movenext
                        Loop
                        End if
                        ...
                        Do while not Rs.EOF
                            ...
                            glwdate=Rs(6)
                        %>
                                        <option value="<%=gldepth%>" <% if clng(gldepth)=clng(zfixglass_t) then %> selected <% end if %> ><%=gldepth%></option>
                        <%
                        Rs.movenext
                        Loop
                        End if
                ...
                <div class="canvas-container" id="svgCanvas" style="width: 100%; height: 100%; padding: 0px;">
                    <div class="svg-container" style="width: 100%; height: 100%; padding: 0px;">
                        ...
                        <%
                            ...
                            If (clng(glassselect_auto) = 1 Or clng(glassselect_auto) = 2) Or (clng(glassselect_fix) = 1 Or clng(glassselect_fix) = 2) Then
...
<script src="/documents/dgsOrder/assets/js/full.js"></script>
