...
SQL="Select max(fidx) From tk_frame "
    ...
    End If
    Rs.Close
response.write "<script>location.replace('TNG1_FRAME.asp?rfidx="&rfidx&"');</script>"
end If
'================================
'프레임 생성 끝
...
if part="fmupdate" then 
  ...
  WHICHI_AUTO=Request("WHICHI_AUTO")
  WHICHI_FIX=Request("WHICHI_FIX")
  sunstatus=Request("sunstatus")

  SQL = "Update tk_frameSub "
  SQL = SQL & "Set xi='" & axi & "', yi='" & ayi & "', wi='" & awi & "', hi='" & ahi & "', WHICHI_AUTO='" & WHICHI_AUTO & "', WHICHI_FIX='" & WHICHI_FIX & "' , sunstatus='" & sunstatus & "' "
  ...
  response.write "<script>location.replace('TNG1_FRAME.asp?rfidx="&rfidx&"&rfsidx="&rfsidx&"');</script>"
end if
'================================
'부속 수정하기 끝
