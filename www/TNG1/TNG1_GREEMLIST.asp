...
<!--거래처 시작 -->
            <div class="card card-body mb-1"><!-- *  11111111111  -->
                <form name="frmMain" method="post" action="TNG1_GREEMLIST.asp" >
                    <div class="row">
                        <div class="col-3">
                        <!-- -->
                          ...
                          <label>
                              ...
                              <% If rgreem_f_a = "2" Then Response.Write "checked" end if %>> 자동
                          </label>
                        <!-- -->
                        <!-- 
                          <label>
                        ...
                        <div class="col-2">
                            <select name="greem_basic_type" class="form-control" onchange="this.form.submit();">
                                <option value="">세부 타입 선택</option>
                                    ...
                                    sql = sql & "WHERE GREEM_F_A = '" & rgreem_f_a & "' ORDER BY greem_basic_type asc"
                ...
                <div class="row ">
                    ...
                    Select Case greem_fix_type
                        ...
                        Case "15"
                            greem_fix_type_name = "편개_상부남마_중"
                        Case "16"
                            greem_fix_type_name = "좌_편개"
                        Case "17"
                            greem_fix_type_name = "우_편개"
                        Case "18"
                            greem_fix_type_name = "좌_양개"
                        Case "19"
                            greem_fix_type_name = "우_양개"
                        Case "20"
                            greem_fix_type_name = "좌_픽스"
                        Case "21"
                            greem_fix_type_name = "우_픽스"      
                        Case "22"
                            greem_fix_type_name = "좌_편개_남마"
                        Case "23"
                            greem_fix_type_name = "우_편개_남마"
                        Case "24"
                            greem_fix_type_name = "좌_양개_남마"
                        Case "25"
                            greem_fix_type_name = "우_양개_남마"
                        Case "26"
                            greem_fix_type_name = "좌_픽스_남마"
                        Case "27"
                            greem_fix_type_name = "우_픽스_남마"  
                        Case "28"
                            greem_fix_type_name = "편개_박스라인"    
                        Case "29"
                            greem_fix_type_name = "양개_박스라인"  
                        Case "30"
                            greem_fix_type_name = "고정창_박스라인"      
                        Case "31"
                            greem_fix_type_name = "편개_상부남마_박스라인"        
                        Case "32"
                            greem_fix_type_name = "양개_상부남마_박스라인"      
                        Case "33"
                            greem_fix_type_name = "고정창_상부남마_박스라인"  
                        Case "34"
                            greem_fix_type_name = "편개_상부남마_중_박스라인"
                        Case "35"
                            greem_fix_type_name = "좌_편개_박스라인"
                        Case "36"
                            greem_fix_type_name = "우_편개_박스라인"
                        Case "37"
                            greem_fix_type_name = "좌_양개_박스라인"
                        Case "38"
                            greem_fix_type_name = "우_양개_박스라인"
                        Case "39"
                            greem_fix_type_name = "좌_픽스_박스라인"
                        Case "40"
                            greem_fix_type_name = "우_픽스_박스라인"      
                        Case "41"
                            greem_fix_type_name = "좌_편개_남마_박스라인"
                        Case "42"
                            greem_fix_type_name = "우_편개_남마_박스라인"
                        Case "43"
                            greem_fix_type_name = "좌_양개_남마_박스라인"
                        Case "44"
                            greem_fix_type_name = "우_양개_남마_박스라인"
                        Case "45"
                            greem_fix_type_name = "좌_픽스_남마_박스라인"
                        Case "46"
                            greem_fix_type_name = "우_픽스_남마_박스라인" 
                        Case Else
                            greem_fix_type_name = "기타 타입"
                    End Select
                    ' ▼ greem_habar_type 변환
                        ...
                        <div class="card card-body mb-1">
                            <div class="canvas-container">
                                ...
                                <text id="height-label" class="dimension-label"></text>
                                    ...
                                    %>
                                            <rect x="<%=xi%>" y="<%=yi%>" width="<%=wi%>" height="<%=hi%>" fill="<%=fillColor%>" stroke="#333333" onclick="del('<%=fsidx%>');"/>
