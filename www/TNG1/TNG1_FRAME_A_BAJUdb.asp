...
SQL="Select max(fidx) From tk_frame "
    ...
    End If
    Rs.Close
response.write "<script>location.replace('TNG1_FRAME_A_BAJU.asp?rfidx="&rfidx&"');</script>"
end If
'================================
'프레임 생성 끝
...
if part="fmupdate" then 
  ...
  response.write "<script>location.replace('TNG1_FRAME_A_BAJU.asp?rfidx="&rfidx&"&rfsidx="&rfsidx&"');</script>"
end if
'================================
'부속 수정하기 끝
