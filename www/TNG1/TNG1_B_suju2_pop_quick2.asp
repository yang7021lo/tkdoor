...
'response.write "    window.opener.location.href = 'TNG1_B_suju_quick.asp?cidx=" & rcidx & _
'    "&sjidx=" & rsjidx & _
'    "&sjsidx=" & rsjsidx & _
'    "&fkidx=" & rfkidx & _
'    "&sjb_idx=" & rsjb_idx & _
...
'    "&fksidx=" & rfksidx & _
'    "&mode=auto_enter';" '자동폼 코드임... 검측입력값이 suju_cal 폼에 걸리게.
'response.write "}"
        ...
        <div class="third-inner">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <% elseif bfimg1<>"" then %>
                    <a onclick="chgbarasif('<%=bfidx%>');"><img src="/img/frame/bfimg/<%=bfimg1%>" loading="lazy" width="180" height="100"  border="0"></a>
                    <% elseif bfimg2<>"" then %>
                    <a onclick="chgbarasif('<%=bfidx%>');"><img src="/img/frame/bfimg/<%=bfimg2%>" loading="lazy" width="180" height="100"  border="0"></a>
                    <% end if %>
                </div>
            </div>
                <%
