...
<body class="bg-light">
    ...
    <div class="container" style="margin-top: 10px;">
        <div class="card shadow-sm p-4">
            ...
            <form id="sizeForm" action="TNG1_B_totalsize.asp" method="post">
            ...
            <%
                ...
                If IsNumeric(ytw) Then total_tw = total_tw + ytw
                ...
                sql="update tng_sjaSub set mwidth='"&total_tw&"' , mheight='"&mheight&"' "
                sql=sql&"where sjsidx = '" & rsjsidx & "'"
...
elseif gubun="in1sert" then 
  ...
  Rs.open Sql,Dbcon
    rsjsidx=Rs(0)
  Rs.Close
  response.write "<script>opener.location.replace('TNG1_B_suju2.asp?cidx="&rcidx&"&sjidx="&rsjidx&"&sjb_idx="&rsjb_idx&"&sjb_type_no="&rsjb_type_no&"&sjsidx="&rsjsidx&"');window.close();</script>"
