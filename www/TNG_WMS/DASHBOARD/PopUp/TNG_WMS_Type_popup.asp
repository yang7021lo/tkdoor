...
<form method="post" action="TNG_WMS_Type_popup.asp">
    ...
    <label>🏢 거래처명</label>
    <input type="text" name="recv_name" placeholder="예: 00철강, 00목재, 00상사 등" value="<%= recv_name %>">

    <label>📍 받는 지점</label>
    <input type="text" name="recv_addr" placeholder="예: 인천 물류센터" value="<%= recv_addr %>">

    <!--<label>📦 받는 사람 주소</label>
    <input type="text" name="recv_addr1" placeholder="예: 경기도 수원시..." value="">-->

    <label>📞 전화번호</label>
    <input type="text" id="recv_tel" name="recv_tel"
           placeholder="예: 010-1234-5678" value="<%= recv_tel %>">
