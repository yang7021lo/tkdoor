                                ...
                                <button type="button"
                                    ...
                                    onclick="(async () => {
                                        try {
                                            ...
                                            // 1️⃣ 첫 번째 URL : 발주서 저장
                                            // -----------------------------
                                            const url1 = '/TNG1/TNG1_B_baljuDB.asp?sjcidx=<%=rsjcidx%>&sjmidx=<%=rsjmidx%>&sjidx=<%=rsjidx%>';
                                            ...
                                            // 2️⃣ 두 번째 URL : WMS 생성
                                            // -----------------------------
                                            const url2 = '/TNG_WMS/TNG_WMS_Create.asp?sjidx=<%=rsjidx%>';
                    ...
                    <div class="menu-container">
                        ...
                        <div class="dropdown-content" id="custom-dropdown-3"> 
                            <div class="input-group mb-2" style="overflow-x: auto; white-space: nowrap;">
                                        ...
                                        SQL=SQL&" ,c.set_name_fix,c.set_name_auto ,a.sjb_idx, a.sjb_type_no , b.bfidx  "
                                        SQL=SQL&" from tk_framek A "
